            ...
            <div class="rs-payment-box">
                ...
                <?php else: ?>
                    ...
                    <div class="rs-flex rs-justify-center rs-mt-4 rs-action-block">
                        <a style="background-color:blue;" target="_blank" class="button alt rs-flex rs-payment-url rswc-button" href="<?= $order->get_meta('_gateway_payment_url'); ?>">
                        ...
                        <a style="background-color:green;" href="#" id="js-alipay-fail" class="button rswc-button rs-flex alt2 rs-ml-4">
