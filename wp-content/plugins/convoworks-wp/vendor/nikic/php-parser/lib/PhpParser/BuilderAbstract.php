...
use Convoworks\PhpParser\Comment;
use Convoworks\PhpParser\Node\Expr;
use Convoworks\PhpParser\Node\Name;
use Convoworks\PhpParser\Node\NullableType;
...
abstract class BuilderAbstract implements Builder
{
    ...
    protected function normalizeName($name)
    {
        ...
        throw new \LogicException('Convoworks\\Name must be a string or an instance of PhpParser\\Node\\Name');
    }
    /**
    ...
    protected function normalizeDocComment($docComment)
    {
        if ($docComment instanceof Comment\Doc) {
            ...
            if (\is_string($docComment)) {
                ...
                throw new \LogicException('Convoworks\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
            }
        }
    }
    /**
