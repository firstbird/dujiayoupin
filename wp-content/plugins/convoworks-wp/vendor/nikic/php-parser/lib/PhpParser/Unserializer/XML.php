...
namespace Convoworks\PhpParser\Unserializer;

use DomainException;
use Convoworks\PhpParser\Unserializer;
use XMLReader;
/**
 * @deprecated
 */
class XML implements Unserializer
{
    ...
    protected function readNode()
    {
        ...
        $node = \unserialize(\sprintf("O:%d:\"%s\":1:{s:13:\"\x00*\x00attributes\";a:0:{}}", \strlen($className), $className));
