...
namespace Convoworks\PhpParser\PrettyPrinter;

use Convoworks\PhpParser\Node;
use Convoworks\PhpParser\Node\Expr;
use Convoworks\PhpParser\Node\Expr\AssignOp;
use Convoworks\PhpParser\Node\Expr\BinaryOp;
use Convoworks\PhpParser\Node\Expr\Cast;
...
use Convoworks\PhpParser\PrettyPrinterAbstract;
class Standard extends PrettyPrinterAbstract
{
    ...
    {
        static $map = array(Expr\Include_::TYPE_INCLUDE => 'include', Expr\Include_::TYPE_INCLUDE_ONCE => 'include_once', Expr\Include_::TYPE_REQUIRE => 'require', Expr\Include_::TYPE_REQUIRE_ONCE => 'require_once');
