...
use Convoworks\PhpParser\Node\Expr\Include_;
use Convoworks\PhpParser\Node\Stmt\Class_;
use Convoworks\PhpParser\Node\Stmt\GroupUse;
use Convoworks\PhpParser\Node\Stmt\Use_;
                ...
                if (null === $value) {
                    ...
                    if ('flags' === $key || 'newModifier' === $key) {
                        ...
                        if ('type' === $key && $node instanceof Include_) {
                            ...
                            if ('type' === $key && ($node instanceof Use_ || $node instanceof UseUse || $node instanceof GroupUse)) {
