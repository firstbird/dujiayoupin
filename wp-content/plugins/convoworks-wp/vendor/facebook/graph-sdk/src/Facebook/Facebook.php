 ...
 *
 */
namespace Convoworks\Facebook;

use Convoworks\Facebook\Authentication\AccessToken;
use Convoworks\Facebook\Authentication\OAuth2Client;
use Convoworks\Facebook\FileUpload\FacebookFile;
use Convoworks\Facebook\FileUpload\FacebookResumableUploader;
use Convoworks\Facebook\FileUpload\FacebookTransferChunk;
use Convoworks\Facebook\FileUpload\FacebookVideo;
use Convoworks\Facebook\GraphNodes\GraphEdge;
use Convoworks\Facebook\Url\UrlDetectionInterface;
use Convoworks\Facebook\Url\FacebookUrlDetectionHandler;
use Convoworks\Facebook\PseudoRandomString\PseudoRandomStringGeneratorFactory;
use Convoworks\Facebook\PseudoRandomString\PseudoRandomStringGeneratorInterface;
use Convoworks\Facebook\HttpClients\HttpClientsFactory;
use Convoworks\Facebook\PersistentData\PersistentDataFactory;
use Convoworks\Facebook\PersistentData\PersistentDataInterface;
use Convoworks\Facebook\Helpers\FacebookCanvasHelper;
use Convoworks\Facebook\Helpers\FacebookJavaScriptHelper;
use Convoworks\Facebook\Helpers\FacebookPageTabHelper;
use Convoworks\Facebook\Helpers\FacebookRedirectLoginHelper;
use Convoworks\Facebook\Exceptions\FacebookSDKException;
/**
 * Class Facebook
 *
 * @package Facebook
...
class Facebook
{
    ...
    public function setDefaultAccessToken($accessToken)
    {
        ...
        throw new \InvalidArgumentException('Convoworks\\The default access token must be of type "string" or Facebook\\AccessToken');
    }
    /**
