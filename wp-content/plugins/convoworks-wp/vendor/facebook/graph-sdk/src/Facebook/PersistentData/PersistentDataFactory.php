 ...
 *
 */
namespace Convoworks\Facebook\PersistentData;
...
class PersistentDataFactory
{
    ...
    public static function createPersistentDataHandler($handler)
    {
        ...
        throw new InvalidArgumentException('Convoworks\\The persistent data handler must be set to "session", "memory", or be an instance of Facebook\\PersistentData\\PersistentDataInterface');
    }
}
