...
class FacebookStreamHttpClient implements FacebookHttpClientInterface
{
    ...
    {
        $options = ['http' => ['method' => $method, 'header' => $this->compileHeader($headers), 'content' => $body, 'timeout' => $timeOut, 'ignore_errors' => \true], 'ssl' => [
            'verify_peer' => \true,
            'verify_peer_name' => \true,
            'allow_self_signed' => \true,
