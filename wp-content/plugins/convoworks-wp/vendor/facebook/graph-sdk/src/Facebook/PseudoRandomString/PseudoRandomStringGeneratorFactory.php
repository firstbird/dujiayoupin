 ...
 *
 */
namespace Convoworks\Facebook\PseudoRandomString;
...
class PseudoRandomStringGeneratorFactory
{
    ...
    public static function createPseudoRandomStringGenerator($generator)
    {
        ...
        throw new InvalidArgumentException('Convoworks\\The pseudo random string generator must be set to "random_bytes", "mcrypt", "openssl", or "urandom", or be an instance of Facebook\\PseudoRandomString\\PseudoRandomStringGeneratorInterface');
    }
    /**
