 ...
 *
 */
namespace Convoworks\Facebook\HttpClients;

use Convoworks\GuzzleHttp\Client;
...
class HttpClientsFactory
{
    ...
    public static function createHttpClient($handler)
    {
        ...
        if ('guzzle' === $handler && !\class_exists('Convoworks\\GuzzleHttp\\Client')) {
        ...
        throw new InvalidArgumentException('Convoworks\\The http client handler must be set to "curl", "stream", "guzzle", be an instance of GuzzleHttp\\Client or an instance of Facebook\\HttpClients\\FacebookHttpClientInterface');
    }
    /**
    ...
    private static function detectDefaultClient()
    {
        ...
        if (\class_exists('Convoworks\\GuzzleHttp\\Client')) {
            return new FacebookGuzzleHttpClient();
        }
        return new FacebookStreamHttpClient();
    }
