 ...
 *
 */
namespace Convoworks\Facebook\GraphNodes;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = 'Convoworks\\Facebook\\GraphNodes\\GraphNode';
    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = 'Convoworks\\Facebook\\GraphNodes\\GraphEdge';
    /**
     ...
     * @throws FacebookSDKException
     */
    public function makeGraphEdge($subclassName = null, $auto_prefix = \true)
    {
        $this->validateResponseAsArray();
