...
namespace Convoworks\GuzzleHttp;

use Convoworks\GuzzleHttp\Cookie\CookieJarInterface;
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('Convoworks\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
