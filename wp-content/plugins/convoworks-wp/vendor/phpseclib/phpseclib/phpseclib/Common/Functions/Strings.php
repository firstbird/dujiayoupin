 ...
 */
namespace Convoworks\phpseclib3\Common\Functions;

use Convoworks\ParagonIE\ConstantTime\Base64;
use Convoworks\ParagonIE\ConstantTime\Base64UrlSafe;
use Convoworks\ParagonIE\ConstantTime\Hex;
use Convoworks\phpseclib3\Math\BigInteger;
use Convoworks\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
