 ...
 */
namespace Convoworks\phpseclib3\Math\BigInteger\Engines\PHP;

use Convoworks\phpseclib3\Math\BigInteger\Engines\Engine;
use Convoworks\phpseclib3\Math\BigInteger\Engines\PHP;
use Convoworks\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
