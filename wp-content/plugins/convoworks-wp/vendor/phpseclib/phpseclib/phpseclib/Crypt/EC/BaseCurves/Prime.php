 ...
 */
namespace Convoworks\phpseclib3\Crypt\EC\BaseCurves;

use Convoworks\phpseclib3\Common\Functions\Strings;
use Convoworks\phpseclib3\Math\BigInteger;
use Convoworks\phpseclib3\Math\Common\FiniteField\Integer;
use Convoworks\phpseclib3\Math\PrimeField;
use Convoworks\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
    ...
    public function setBasePoint($x, $y)
    {
        switch (\true) {
            case !$x instanceof BigInteger && !$x instanceof PrimeInteger:
                throw new \UnexpectedValueException('Convoworks\\Argument 1 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
            case !$y instanceof BigInteger && !$y instanceof PrimeInteger:
                throw new \UnexpectedValueException('Convoworks\\Argument 2 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
        }
        if (!isset($this->factory)) {
            throw new \RuntimeException('setModulo needs to be called before this method');
        }
