 ...
 */
namespace Convoworks\phpseclib3\Crypt\EC\Formats\Keys;

use Convoworks\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
use Convoworks\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use Convoworks\phpseclib3\File\ASN1\Maps;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (!$params) {
            throw new \RuntimeException('Convoworks\\Unable to decode the parameters using Maps\\ECParameters');
        }
        $components = [];
