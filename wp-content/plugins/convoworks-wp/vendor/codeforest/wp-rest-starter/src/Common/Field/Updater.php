...
# -*- coding: utf-8 -*-
namespace Convoworks\Inpsyde\WPRESTStarter\Common\Field;
...
interface Updater
{
     ...
     */
    public function update_value($value, $object, string $field_name, \WP_REST_Request $request = null, string $object_type = '') : bool;
}
