...
namespace Convoworks\Inpsyde\WPRESTStarter\Core\Route;

use Convoworks\Inpsyde\WPRESTStarter\Common\Arguments;
use Convoworks\Inpsyde\WPRESTStarter\Common\Endpoint\RequestHandler;
use Convoworks\Inpsyde\WPRESTStarter\Common\Endpoint\Schema;
use Convoworks\Inpsyde\WPRESTStarter\Common\Route\ExtensibleOptions;
use Convoworks\Inpsyde\WPRESTStarter\Common\Route\SchemaAwareOptions;
/**
...
final class Options implements ExtensibleOptions, SchemaAwareOptions
{
     ...
     */
    public static function from_arguments(RequestHandler $handler = null, Arguments $args = null, string $methods = self::DEFAULT_METHODS, array $options = []) : Options
    {
        if ($handler) {
     ...
     * @return Options Route options object.
     */
    public static function with_callback(callable $callback, array $args = [], string $methods = self::DEFAULT_METHODS, array $options = []) : Options
    {
