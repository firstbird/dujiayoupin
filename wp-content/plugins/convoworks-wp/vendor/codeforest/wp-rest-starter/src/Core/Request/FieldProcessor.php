...
use Convoworks\Inpsyde\WPRESTStarter\Core;
/**
...
final class FieldProcessor implements Common\Request\FieldProcessor
{
     ...
     */
    public function update_fields_for_object(array $object, \WP_REST_Request $request, string $object_type = '') : bool
    {
        ...
        foreach ($fields as $name => $definition) {
            ...
            if (\Convoworks\is_wp_error($result)) {
