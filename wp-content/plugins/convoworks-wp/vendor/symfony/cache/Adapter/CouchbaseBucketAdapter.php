...
class CouchbaseBucketAdapter extends AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\Convoworks\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, ?MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \Convoworks\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \Convoworks\CouchbaseCluster($connectionString);
