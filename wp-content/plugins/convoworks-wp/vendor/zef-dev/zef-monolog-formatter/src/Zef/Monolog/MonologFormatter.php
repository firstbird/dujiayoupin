...
namespace Convoworks\Zef\Monolog;

class MonologFormatter extends \Convoworks\Monolog\Formatter\LineFormatter
{
    ...
    public function format(array $record) : string
    {
        ...
        if (isset($backtrace[$DEPTH]['class']) && \trim($backtrace[$DEPTH]['class'])) {
