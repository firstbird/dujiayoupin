...
use ZipArchive;
class ZipFileResource implements \Convo\Core\Util\IFileResource
{
    private $_filename;
    ...
    {
        return \get_class($this) . '[' . $this->_filename . '][' . $this->_contentType . '][' . $this->getSize() . '][' . \print_r($this->_structure, \true) . ']';
    }
}
