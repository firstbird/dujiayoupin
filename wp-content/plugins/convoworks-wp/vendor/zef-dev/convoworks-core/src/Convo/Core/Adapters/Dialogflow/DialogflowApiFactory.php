...
class DialogflowApiFactory
{
    ...
    {
        return new \Convo\Core\Adapters\Dialogflow\DialogflowApi($this->_logger, $this->_convoServiceDataProvider, $user, $serviceId, $this->_adminUserDataProvider, $platformId, $this->_httpFactory);
    }
}
