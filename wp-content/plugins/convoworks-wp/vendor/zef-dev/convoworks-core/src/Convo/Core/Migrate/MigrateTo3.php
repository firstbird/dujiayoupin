...
class MigrateTo3 extends \Convo\Core\Migrate\AbstractMigration
{
    ...
    protected function _migrateService($serviceData)
    {
        ...
        if (!$found) {
            $serviceData['blocks'][] = ['class' => '\\Convo\\Pckg\\Core\\Elements\\ConversationBlock', 'properties' => ['block_id' => \Convo\Core\ConvoServiceInstance::BLOCK_TYPE_MEDIA_CONTROLS, 'elements' => [], 'processors' => []]];
        }
        return $serviceData;
    }
}
