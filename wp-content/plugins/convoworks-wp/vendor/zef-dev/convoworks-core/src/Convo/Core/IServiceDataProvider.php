...
{
    const DEFAULT_WORKFLOW = ['service_id' => null, 'convo_service_version' => \Convo\Core\Factory\ConvoServiceFactory::SERVICE_VERSION, 'packages' => ['convo-core'], 'contexts' => [], 'variables' => [], 'preview_variables' => [], 'entities' => [], 'intents' => [], 'blocks' => [], 'fragments' => [], 'time_updated' => 0, 'intents_time_updated' => 0];
    const DEFAULT_META = ['service_id' => null, 'name' => null, 'description' => null, 'default_language' => \Convo\Core\IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH, 'default_locale' => \Convo\Core\IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_US, 'supported_locales' => [\Convo\Core\IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_US], 'active' => 0, 'is_private' => \false, 'owner' => null, 'admins' => [], 'release_mapping' => [], 'time_updated' => 0];
    const DEFAULT_RELEASE = ['service_id' => null, 'release_id' => null, 'platform_id' => null, 'version_id' => null, 'type' => null, 'stage' => null, 'alias' => null, 'time_created' => 0, 'time_updated' => 0];
    const DEFAULT_AMAZON_CONFIG = ['mode' => 'manual', 'invocation' => 'Default Name', 'app_id' => null, 'upload_own_skill_icons' => \false, 'interaction_model_sensitivity' => 'LOW', 'endpoint_ssl_certificate_type' => 'Wildcard', 'self_signed_certificate' => null, 'auto_display' => \false, 'skill_preview_in_store' => ['public_name' => 'Default Name', 'one_sentence_description' => 'Default Name', 'detailed_description' => 'Default Name', 'whats_new' => 'Default Name', 'example_phrases' => ['Alexa, open Default Name'], 'small_skill_icon' => 'https://via.placeholder.com/108.png/09f/fffC/O', 'large_skill_icon' => 'https://via.placeholder.com/512.png/09f/fffC/O', 'category' => 'ALARMS_AND_CLOCKS', 'keywords' => [], 'privacy_policy_url' => '', 'terms_of_use_url' => ''], 'privacy_and_compliance' => ['allows_purchases' => \false, 'uses_personal_info' => \false, 'is_child_directed' => \false, 'contains_ads' => \false, 'is_export_compliant' => \false, 'testing_instructions' => \false]];
    /**
