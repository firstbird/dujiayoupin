                            ...
                            if ($info->startsWith('service-run/facebook_messenger')) {
                                ...
                                if ($info->startsWith('service-run/viber')) {
                                    ...
                                    if ($info->startsWith('service-run')) {
                                        ...
                                        if ($info->startsWith('service-media')) {
                                            $class_name = '\\Convo\\Core\\Media\\MediaRestHandler';
                                        } else {
                                            if ($info->startsWith('service-catalogs')) {
