...
class AlexaSkillLanguageMapper implements IConvoServiceLanguageMapper
{
    ...
    public static function getSupportedLocalesByLocale($locale)
    {
        switch ($locale) {
            case IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH:
                return [IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_IN, IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_GB, IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_CA, IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_AU, IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_US];
            case IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_US:
            case IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_AU:
            case IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_CA:
            case IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_GB:
    ...
    {
        $allEnglish = [IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_US, IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_CA, IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_GB, IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_AU, IConvoServiceLanguageMapper::CONVO_SERVICE_ENGLISH_IN];
        $locale = $locales[0];
