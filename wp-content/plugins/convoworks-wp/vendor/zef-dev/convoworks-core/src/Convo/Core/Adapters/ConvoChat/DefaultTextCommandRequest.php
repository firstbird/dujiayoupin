...
class DefaultTextCommandRequest implements \Convo\Core\Workflow\IConvoRequest
{
    ...
    {
        return \get_class($this) . '[' . $this->_platformId . '][' . $this->_serviceId . '][' . $this->_text . '][' . $this->_deviceId . ']' . '[' . $this->_installationId . '][' . $this->_sessionId . '][' . $this->_requestId . '][' . $this->_isLaunch . '][' . $this->_isEnd . ']';
    }
    /**
     * @inheritDoc
     */
