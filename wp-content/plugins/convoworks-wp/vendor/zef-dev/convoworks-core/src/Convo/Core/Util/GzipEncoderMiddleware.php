...
class GzipEncoderMiddleware implements MiddlewareInterface
{
     ...
     */
    private $_logger;
    const ALLOWED_MIME_TYPES = ["application/json", "application/json+ld", "application/xhtml+xml", "text/javascript", "text/plain", "text/html"];
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler) : ResponseInterface
    {
        ...
        $response = $response->withBody($body)->withHeader('Content-Encoding', 'gzip')->withHeader('Content-Length', $body->getSize());
        return $response;
    }
