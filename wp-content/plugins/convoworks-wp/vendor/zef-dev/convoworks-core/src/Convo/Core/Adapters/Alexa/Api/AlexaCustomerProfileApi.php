...
class AlexaCustomerProfileApi extends \Convo\Core\Adapters\Alexa\Api\AlexaApi
{
    ...
    public function getCustomerFullName(AmazonCommandRequest $request)
    {
        try {
            ...
            switch ($e->getCode()) {
                case 401:
                case 403:
                    throw new \Convo\Core\Adapters\Alexa\Api\InsufficientPermissionsGrantedException('Missing [alexa::profile:name:read] permission.', null, $e);
                default:
    ...
    public function getCustomerGivenName(AmazonCommandRequest $request)
    {
        try {
            ...
            switch ($e->getCode()) {
                case 401:
                case 403:
                    throw new \Convo\Core\Adapters\Alexa\Api\InsufficientPermissionsGrantedException('Missing [alexa::profile:given_name:read] permission.', null, $e);
                default:
                    throw new \Exception($e->getMessage(), null, $e);
            }
        }
    ...
    public function getCustomerEmailAddress(AmazonCommandRequest $request)
    {
        try {
            ...
            switch ($e->getCode()) {
                case 401:
                case 403:
                    throw new \Convo\Core\Adapters\Alexa\Api\InsufficientPermissionsGrantedException('Missing [alexa::profile:email:read] permission.', null, $e);
                default:
                    throw new \Exception($e->getMessage(), null, $e);
            }
        }
    ...
    public function getCustomerPhoneNumber(AmazonCommandRequest $request)
    {
        try {
            ...
            switch ($e->getCode()) {
                case 401:
                case 403:
                    throw new \Convo\Core\Adapters\Alexa\Api\InsufficientPermissionsGrantedException('Missing [alexa::profile:mobile_number:read] permission.', null, $e);
                default:
                    throw new \Exception($e->getMessage(), null, $e);
            }
        }
