...
class SlotValue
{
    ...
    public function addTokenValue($value, \Convo\Pckg\Gnlp\GoogleNlSyntaxToken $token)
    {
        $this->_pairs[] = ['value' => $value, 'token' => $token];
    }
    public function getTokenValue(\Convo\Pckg\Gnlp\GoogleNlSyntaxToken $token)
    {
