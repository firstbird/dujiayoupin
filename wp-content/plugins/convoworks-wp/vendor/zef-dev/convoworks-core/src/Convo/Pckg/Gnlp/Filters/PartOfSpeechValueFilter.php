...
class PartOfSpeechValueFilter implements \Convo\Pckg\Gnlp\Filters\ITextFilter, \Psr\Log\LoggerAwareInterface
{
    public static $DFAULTS = array('multiple' => \false, 'exclusive' => \false, 'force_proper' => \false);
    private $_type;
    private $_value;
    private $_exclusive;
    private $_multiple;
