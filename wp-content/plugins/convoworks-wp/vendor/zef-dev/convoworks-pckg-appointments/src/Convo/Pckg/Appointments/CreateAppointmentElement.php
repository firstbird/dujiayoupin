...
class CreateAppointmentElement extends \Convo\Pckg\Appointments\AbstractAppointmentElement
{
    /**
     * @var string
     */
    ...
    public function read(IConvoRequest $request, IConvoResponse $response)
    {
        ...
        $data = ['appointment_id' => null, 'requested_timezone' => $timezone->getName(), 'requested_time' => $slot_time->getTimestamp(), 'not_allowed' => \false];
        try {
