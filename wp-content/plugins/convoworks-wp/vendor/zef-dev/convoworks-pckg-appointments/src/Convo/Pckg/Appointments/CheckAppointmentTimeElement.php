...
class CheckAppointmentTimeElement extends \Convo\Pckg\Appointments\AbstractAppointmentElement
{
    /**
     * @var string
     */
    ...
    public function read(IConvoRequest $request, IConvoResponse $response)
    {
        ...
        $data = ['suggestions' => [], 'requested_time' => $slot_time->getTimestamp(), 'requested_timezone' => $timezone->getName(), 'not_allowed' => \false];
        if ($date && $time) {
