 ...
 */
namespace Convoworks\Composer;

use Convoworks\Composer\Autoload\ClassLoader;
use Convoworks\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Convoworks\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
