...
use Convoworks\Zend\Diactoros\Response;
use Convoworks\Zend\Diactoros\ServerRequest;
use Convoworks\Zend\Diactoros\Stream;
use Convoworks\Zend\Diactoros\Uri;
/**
...
class DiactorosFactory implements ResponseFactoryInterface, ServerRequestFactoryInterface, StreamFactoryInterface, UriFactoryInterface
{
    ...
    {
        return \class_exists('Convoworks\\Zend\\Diactoros\\Response') && \class_exists('Convoworks\\Zend\\Diactoros\\ServerRequest') && \class_exists('Convoworks\\Zend\\Diactoros\\Stream') && \class_exists('Convoworks\\Zend\\Diactoros\\Uri');
    }
    /**
    ...
    {
        return new ServerRequest($serverParams, [], $uri, $method, $this->createStream());
    }
    /**
