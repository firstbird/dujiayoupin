...
use Convoworks\DI\Annotation\Inject;
use Convoworks\DI\Annotation\Injectable;
use Convoworks\DI\Definition\Exception\InvalidAnnotation;
use Convoworks\DI\Definition\ObjectDefinition;
use Convoworks\DI\Definition\ObjectDefinition\MethodInjection;
use Convoworks\DI\Definition\ObjectDefinition\PropertyInjection;
use Convoworks\DI\Definition\Reference;
use Convoworks\Doctrine\Common\Annotations\AnnotationRegistry;
use Convoworks\Doctrine\Common\Annotations\Reader;
use Convoworks\Doctrine\Common\Annotations\SimpleAnnotationReader;
use InvalidArgumentException;
use Convoworks\PhpDocReader\PhpDocReader;
use ReflectionClass;
...
class AnnotationBasedAutowiring implements DefinitionSource, Autowiring
{
    ...
    private function readProperty(ReflectionProperty $property, ObjectDefinition $definition, $classname = null)
    {
        ...
        $annotation = $this->getAnnotationReader()->getPropertyAnnotation($property, 'Convoworks\\DI\\Annotation\\Inject');
    ...
    private function getMethodInjection(ReflectionMethod $method)
    {
        // Look for @Inject annotation
        try {
            $annotation = $this->getAnnotationReader()->getMethodAnnotation($method, 'Convoworks\\DI\\Annotation\\Inject');
    ...
    public function getAnnotationReader()
    {
        if ($this->annotationReader === null) {
            ...
            $this->annotationReader->addNamespace('Convoworks\\DI\\Annotation');
        }
    ...
    private function readInjectableAnnotation(ReflectionClass $class, ObjectDefinition $definition)
    {
        try {
            ...
            $annotation = $this->getAnnotationReader()->getClassAnnotation($class, 'Convoworks\\DI\\Annotation\\Injectable');
