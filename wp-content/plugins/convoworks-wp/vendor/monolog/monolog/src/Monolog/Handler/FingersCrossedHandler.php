...
use Convoworks\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use Convoworks\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use Convoworks\Monolog\Logger;
use Convoworks\Monolog\ResettableInterface;
