...
use Convoworks\PhpConsole\Connector;
use Convoworks\PhpConsole\Handler as VendorPhpConsoleHandler;
use Convoworks\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('Convoworks\\PhpConsole\\Connector')) {
