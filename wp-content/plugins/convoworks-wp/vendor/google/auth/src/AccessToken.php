...
use DateTime;
use Exception;
use Convoworks\Firebase\JWT\ExpiredException;
use Convoworks\Firebase\JWT\JWT;
use Convoworks\Firebase\JWT\Key;
use Convoworks\Firebase\JWT\SignatureInvalidException;
...
use Convoworks\phpseclib\Crypt\RSA;
use Convoworks\phpseclib\Math\BigInteger as BigInteger2;
use Convoworks\phpseclib3\Crypt\PublicKeyLoader;
use Convoworks\phpseclib3\Math\BigInteger as BigInteger3;
use Psr\Cache\CacheItemPoolInterface;
use RuntimeException;
use Convoworks\SimpleJWT\InvalidTokenException;
use Convoworks\SimpleJWT\JWT as SimpleJWT;
use Convoworks\SimpleJWT\Keys\KeyFactory;
use Convoworks\SimpleJWT\Keys\KeySet;
...
class AccessToken
{
    ...
    {
        if (!\class_exists('Convoworks\\phpseclib\\Crypt\\RSA')) {
            return \false;
        }
        /**
    ...
    {
        return \class_exists('Convoworks\\phpseclib3\\Crypt\\RSA');
    }
    /**
     * @return void
     */
