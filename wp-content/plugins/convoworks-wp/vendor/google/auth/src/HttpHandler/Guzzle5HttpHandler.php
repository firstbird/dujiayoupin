...
use Convoworks\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use Convoworks\GuzzleHttp\Promise\Promise;
use Convoworks\GuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('Convoworks\\GuzzleHttp\\Promise\\Promise')) {
