...
use Convoworks\GuzzleHttp\BodySummarizer;
use Convoworks\GuzzleHttp\Client;
use Convoworks\GuzzleHttp\ClientInterface;
use Convoworks\GuzzleHttp\HandlerStack;
use Convoworks\GuzzleHttp\Middleware;
class HttpHandlerFactory
{
    ...
    public static function build(ClientInterface $client = null)
    {
        ...
        $version = null;
        if (\defined('\\Convoworks\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            $version = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\Convoworks\\GuzzleHttp\\ClientInterface::VERSION')) {
