...
class ApiConfig extends \Google\Protobuf\Internal\Message
{
    ...
    {
        \Convoworks\GPBMetadata\GrpcGcp::initOnce();
        parent::__construct();
    }
    /**
     * The channel pool configurations.
    ...
    {
        GPBUtil::checkMessage($var, \Convoworks\Grpc\Gcp\ChannelPoolConfig::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Convoworks\Grpc\Gcp\MethodConfig::class);
        $this->method = $arr;
        return $this;
    }
}
