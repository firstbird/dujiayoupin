...
class UrlTypeHint
{
     ...
     */
    const AMP_CONTENT = 2;
    private static $valueToName = [self::URL_TYPE_HINT_UNSPECIFIED => 'URL_TYPE_HINT_UNSPECIFIED', self::AMP_ACTION => 'AMP_ACTION', self::AMP_CONTENT => 'AMP_CONTENT'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\Intent\Message\BrowseCarouselCard\BrowseCarouselCardItem\OpenUrlAction\UrlTypeHint::class, \Google\Cloud\Dialogflow\V2\Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint::class);
