...
class MatchMode
{
    ...
    private static $valueToName = [self::MATCH_MODE_UNSPECIFIED => 'MATCH_MODE_UNSPECIFIED', self::MATCH_MODE_HYBRID => 'MATCH_MODE_HYBRID', self::MATCH_MODE_ML_ONLY => 'MATCH_MODE_ML_ONLY'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\Agent\MatchMode::class, \Google\Cloud\Dialogflow\V2\Agent_MatchMode::class);
