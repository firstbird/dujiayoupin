...
class SessionsGapicClient
{
    ...
    private static function getPathTemplateMap()
    {
        if (null == self::$pathTemplateMap) {
            self::$pathTemplateMap = ['projectEnvironmentUserSession' => self::getProjectEnvironmentUserSessionNameTemplate(), 'projectSession' => self::getProjectSessionNameTemplate(), 'session' => self::getSessionNameTemplate()];
        }
    ...
    public function detectIntent($session, $queryInput, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor(['session' => $request->getSession()]);
