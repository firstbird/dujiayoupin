...
class EntityOverrideMode
{
    ...
    private static $valueToName = [self::ENTITY_OVERRIDE_MODE_UNSPECIFIED => 'ENTITY_OVERRIDE_MODE_UNSPECIFIED', self::ENTITY_OVERRIDE_MODE_OVERRIDE => 'ENTITY_OVERRIDE_MODE_OVERRIDE', self::ENTITY_OVERRIDE_MODE_SUPPLEMENT => 'ENTITY_OVERRIDE_MODE_SUPPLEMENT'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\SessionEntityType\EntityOverrideMode::class, \Google\Cloud\Dialogflow\V2\SessionEntityType_EntityOverrideMode::class);
