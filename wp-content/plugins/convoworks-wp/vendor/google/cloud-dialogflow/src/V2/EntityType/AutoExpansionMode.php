...
class AutoExpansionMode
{
    ...
    private static $valueToName = [self::AUTO_EXPANSION_MODE_UNSPECIFIED => 'AUTO_EXPANSION_MODE_UNSPECIFIED', self::AUTO_EXPANSION_MODE_DEFAULT => 'AUTO_EXPANSION_MODE_DEFAULT'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\EntityType\AutoExpansionMode::class, \Google\Cloud\Dialogflow\V2\EntityType_AutoExpansionMode::class);
