...
class Kind
{
     ...
     */
    const KIND_REGEXP = 3;
    private static $valueToName = [self::KIND_UNSPECIFIED => 'KIND_UNSPECIFIED', self::KIND_MAP => 'KIND_MAP', self::KIND_LIST => 'KIND_LIST', self::KIND_REGEXP => 'KIND_REGEXP'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\EntityType\Kind::class, \Google\Cloud\Dialogflow\V2\EntityType_Kind::class);
