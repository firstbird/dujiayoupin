...
\class_alias(\Google\Cloud\Dialogflow\V2\Intent\Message\BasicCard\Button\OpenUriAction::class, \Google\Cloud\Dialogflow\V2\Intent_Message_BasicCard_Button_OpenUriAction::class);
