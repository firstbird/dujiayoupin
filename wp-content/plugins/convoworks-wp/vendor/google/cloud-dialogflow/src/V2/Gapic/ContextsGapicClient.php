...
class ContextsGapicClient
{
    ...
    private static function getPathTemplateMap()
    {
        if (null == self::$pathTemplateMap) {
            self::$pathTemplateMap = ['context' => self::getContextNameTemplate(), 'projectEnvironmentUserSession' => self::getProjectEnvironmentUserSessionNameTemplate(), 'projectEnvironmentUserSessionContext' => self::getProjectEnvironmentUserSessionContextNameTemplate(), 'projectSession' => self::getProjectSessionNameTemplate(), 'projectSessionContext' => self::getProjectSessionContextNameTemplate(), 'session' => self::getSessionNameTemplate()];
        }
    ...
    {
        return self::getContextNameTemplate()->render(['project' => $project, 'session' => $session, 'context' => $context]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
    ...
    {
        return self::getProjectEnvironmentUserSessionContextNameTemplate()->render(['project' => $project, 'environment' => $environment, 'user' => $user, 'session' => $session, 'context' => $context]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
    ...
    {
        return self::getProjectSessionContextNameTemplate()->render(['project' => $project, 'session' => $session, 'context' => $context]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
     * a session resource.
    ...
    public function updateContext($context, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor(['context.name' => $request->getContext()->getName()]);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? \array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
