...
class HorizontalAlignment
{
     ...
     */
    const TRAILING = 3;
    private static $valueToName = [self::HORIZONTAL_ALIGNMENT_UNSPECIFIED => 'HORIZONTAL_ALIGNMENT_UNSPECIFIED', self::LEADING => 'LEADING', self::CENTER => 'CENTER', self::TRAILING => 'TRAILING'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\Intent\Message\ColumnProperties\HorizontalAlignment::class, \Google\Cloud\Dialogflow\V2\Intent_Message_ColumnProperties_HorizontalAlignment::class);
