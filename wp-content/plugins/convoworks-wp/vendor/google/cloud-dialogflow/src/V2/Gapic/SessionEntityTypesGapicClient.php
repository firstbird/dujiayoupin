...
class SessionEntityTypesGapicClient
{
     ...
     */
    public static $serviceScopes = ['https://www.googleapis.com/auth/cloud-platform', 'https://www.googleapis.com/auth/dialogflow'];
    ...
    private static function getPathTemplateMap()
    {
        if (null == self::$pathTemplateMap) {
            self::$pathTemplateMap = ['projectEnvironmentUserSession' => self::getProjectEnvironmentUserSessionNameTemplate(), 'projectEnvironmentUserSessionEntityType' => self::getProjectEnvironmentUserSessionEntityTypeNameTemplate(), 'projectSession' => self::getProjectSessionNameTemplate(), 'projectSessionEntityType' => self::getProjectSessionEntityTypeNameTemplate(), 'session' => self::getSessionNameTemplate(), 'sessionEntityType' => self::getSessionEntityTypeNameTemplate()];
        }
    ...
    {
        return self::getProjectEnvironmentUserSessionNameTemplate()->render(['project' => $project, 'environment' => $environment, 'user' => $user, 'session' => $session]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
    ...
    {
        return self::getProjectEnvironmentUserSessionEntityTypeNameTemplate()->render(['project' => $project, 'environment' => $environment, 'user' => $user, 'session' => $session, 'entity_type' => $entityType]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
    ...
    {
        return self::getProjectSessionNameTemplate()->render(['project' => $project, 'session' => $session]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
    ...
    {
        return self::getProjectSessionEntityTypeNameTemplate()->render(['project' => $project, 'session' => $session, 'entity_type' => $entityType]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
     * a session resource.
    ...
    {
        return self::getSessionNameTemplate()->render(['project' => $project, 'session' => $session]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
    ...
    {
        return self::getSessionEntityTypeNameTemplate()->render(['project' => $project, 'session' => $session, 'entity_type' => $entityType]);
    }
    /**
    ...
    public function listSessionEntityTypes($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor(['parent' => $request->getParent()]);
    ...
    public function updateSessionEntityType($sessionEntityType, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor(['session_entity_type.name' => $request->getSessionEntityType()->getName()]);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? \array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
