...
class Tier
{
    ...
    private static $valueToName = [self::TIER_UNSPECIFIED => 'TIER_UNSPECIFIED', self::TIER_STANDARD => 'TIER_STANDARD', self::TIER_ENTERPRISE => 'TIER_ENTERPRISE', self::TIER_ENTERPRISE_PLUS => 'TIER_ENTERPRISE_PLUS'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\Agent\Tier::class, \Google\Cloud\Dialogflow\V2\Agent_Tier::class);
