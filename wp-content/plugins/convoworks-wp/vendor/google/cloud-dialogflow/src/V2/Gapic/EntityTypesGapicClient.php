...
class EntityTypesGapicClient
{
    ...
    private static function getPathTemplateMap()
    {
        if (null == self::$pathTemplateMap) {
            self::$pathTemplateMap = ['agent' => self::getAgentNameTemplate(), 'entityType' => self::getEntityTypeNameTemplate()];
        }
    ...
    {
        return self::getAgentNameTemplate()->render(['project' => $project]);
    }
    /**
     * Formats a string containing the fully-qualified path to represent
    ...
    {
        return self::getEntityTypeNameTemplate()->render(['project' => $project, 'entity_type' => $entityType]);
    }
    /**
    ...
    public function updateEntityType($entityType, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor(['entity_type.name' => $request->getEntityType()->getName()]);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? \array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
