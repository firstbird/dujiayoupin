...
class SpeechModelVariant
{
    ...
    private static $valueToName = [self::SPEECH_MODEL_VARIANT_UNSPECIFIED => 'SPEECH_MODEL_VARIANT_UNSPECIFIED', self::USE_BEST_AVAILABLE => 'USE_BEST_AVAILABLE', self::USE_STANDARD => 'USE_STANDARD', self::USE_ENHANCED => 'USE_ENHANCED'];
