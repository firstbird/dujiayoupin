...
class SsmlVoiceGender
{
    ...
    private static $valueToName = [self::SSML_VOICE_GENDER_UNSPECIFIED => 'SSML_VOICE_GENDER_UNSPECIFIED', self::SSML_VOICE_GENDER_MALE => 'SSML_VOICE_GENDER_MALE', self::SSML_VOICE_GENDER_FEMALE => 'SSML_VOICE_GENDER_FEMALE', self::SSML_VOICE_GENDER_NEUTRAL => 'SSML_VOICE_GENDER_NEUTRAL'];
