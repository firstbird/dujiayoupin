...
class AgentsGapicClient
{
    ...
    private static function getPathTemplateMap()
    {
        if (null == self::$pathTemplateMap) {
            self::$pathTemplateMap = ['project' => self::getProjectNameTemplate()];
        }
    ...
    {
        return self::getProjectNameTemplate()->render(['project' => $project]);
    }
    /**
    ...
    public function setAgent($agent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor(['agent.parent' => $request->getAgent()->getParent()]);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? \array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
