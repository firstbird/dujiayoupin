...
class IntentsGapicClient
{
    ...
    private static function getPathTemplateMap()
    {
        if (null == self::$pathTemplateMap) {
            self::$pathTemplateMap = ['agent' => self::getAgentNameTemplate(), 'intent' => self::getIntentNameTemplate()];
        }
    ...
    {
        return self::getIntentNameTemplate()->render(['project' => $project, 'intent' => $intent]);
    }
    /**
    ...
    public function updateIntent($intent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor(['intent.name' => $request->getIntent()->getName()]);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? \array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
