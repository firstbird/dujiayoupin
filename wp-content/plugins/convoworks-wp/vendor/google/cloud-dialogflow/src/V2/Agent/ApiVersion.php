...
class ApiVersion
{
    ...
    private static $valueToName = [self::API_VERSION_UNSPECIFIED => 'API_VERSION_UNSPECIFIED', self::API_VERSION_V1 => 'API_VERSION_V1', self::API_VERSION_V2 => 'API_VERSION_V2', self::API_VERSION_V2_BETA_1 => 'API_VERSION_V2_BETA_1'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\Agent\ApiVersion::class, \Google\Cloud\Dialogflow\V2\Agent_ApiVersion::class);
