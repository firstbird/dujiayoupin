...
\class_alias(\Google\Cloud\Dialogflow\V2\Intent\Message\MediaContent\ResponseMediaObject::class, \Google\Cloud\Dialogflow\V2\Intent_Message_MediaContent_ResponseMediaObject::class);
