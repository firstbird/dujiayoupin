...
class Platform
{
    ...
    private static $valueToName = [self::PLATFORM_UNSPECIFIED => 'PLATFORM_UNSPECIFIED', self::FACEBOOK => 'FACEBOOK', self::SLACK => 'SLACK', self::TELEGRAM => 'TELEGRAM', self::KIK => 'KIK', self::SKYPE => 'SKYPE', self::LINE => 'LINE', self::VIBER => 'VIBER', self::ACTIONS_ON_GOOGLE => 'ACTIONS_ON_GOOGLE', self::GOOGLE_HANGOUTS => 'GOOGLE_HANGOUTS'];
...
\class_alias(\Google\Cloud\Dialogflow\V2\Intent\Message\Platform::class, \Google\Cloud\Dialogflow\V2\Intent_Message_Platform::class);
