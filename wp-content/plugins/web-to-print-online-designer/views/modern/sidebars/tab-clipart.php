<div class="<?php if( $active_cliparts ) echo 'active'; ?> tab nbd-onload" ng-if="'yes' == 'yes'" id="tab-svg" nbd-scroll="scrollLoadMore(container, type)" data-container="#tab-svg" data-type="clipart" data-offset="20">
