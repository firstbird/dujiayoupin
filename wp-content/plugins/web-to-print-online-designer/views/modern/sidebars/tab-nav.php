<div class="tabs-nav">
    ...
    <ul class="main-tabs" data-tab="tab-1">
        ...
        <li id="nav-backgrounds" data-tour="backgrounds" data-tour-priority="4" ng-click="disableDrawMode();disablePreventClickMode();loadOSSFiles('background', '#tab-background')" class="<?php if( $active_backgrounds ) echo 'active'; ?> tab animated <?php echo( $animation_dir ); ?> animate600 tab-background" ng-if="settings['nbdesigner_enable_clipart'] == 'yes'"><i class="icon-nbd icon-nbd-sharp-star" ></i><span><?php esc_html_e('Backgrounds','web-to-print-online-designer'); ?></span></li>
