<div class="tabs-nav">
    ...
    <ul class="main-tabs" data-tab="tab-1">
        ...
        <li id="nav-backgrounds" data-tour="photos" data-tour-priority="4" class="<?php if( $active_backgrounds ) echo 'active'; ?> tab animated <?php echo( $animation_dir ); ?> animate700" ng-click="disableDrawMode();disablePreventClickMode()" ng-if="settings['nbdesigner_enable_image'] == 'yes'"><i class="icon-nbd icon-nbd-images" ></i><span><?php esc_html_e('Backgrounds','web-to-print-online-designer'); ?></span></li>
