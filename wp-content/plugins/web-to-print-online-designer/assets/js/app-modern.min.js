...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document', '$interval',
    ...
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            background: {filter: {perPage: 10, currentPage: 1, total: 0}, data: [], onload: false, init: true, ilr: false, progressBar: 0},
    ...
    $scope.getResource = function(type, container, callback){
        console.log('getResource --- type:', type);
    ...
    $scope.afterGetResource = function(type){
        console.log('afterGetResource begin --- type:', type, ' total:', $scope.resource[type].filter.total);
        switch(type){
            case 'clipart':
        ...
        console.log('afterGetResource end --- type:', type, ' total:', $scope.resource[type].filter.total);
