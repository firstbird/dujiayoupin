...
nbdApp.controller('designCtrl', 
    ...
    $scope.defaultElementPath = '/wp-content/plugins/web-to-print-online-designer/assets/images/';
    ...
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            lines: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '线条'},
