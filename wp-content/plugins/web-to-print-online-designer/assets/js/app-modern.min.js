...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document', '$interval',
    ...
    $scope.initSettings = function(){
        ...
        console.log('init setting background: ', $scope.resource.background);
    };

    $scope.openPhotoAlbum = function() {
        console.log('Opening photo album...'); // 添加调试日志
        jQuery('#nbd-photo-album').modal('show');
    ...
    $scope.loadUserPhotos = function() {
        ...
        NBDDataFactory.get('nbdesigner_get_user_photos', {}, function(data) {
            ...
            if (data.success) {
                $scope.userPhotos = data.data.photos || [];
            } else {
...
/*                 if( angular.isDefined( data.area ) ){
            ...
            reader.onload = function(event){
                if (event.target.readyState === 2) {
                    ...
                    // if( !isBackground ){
                        $scope.addSvgFromString(result);
                    // } else {
                    //     console.log('uploadFile setBackgroundUrl isBackground', isBackground);
                    //     //$scope.setBackgroundUrl(result);
                    //     $timeout(function(){
                    //         $scope.toggleStageLoading();
                    //     });
                    // }
            ...
            NBDDataFactory.get('nbdesigner_customer_upload', {file: file}, function(data){
                ...
                if( data.flag == 1 ){
                    ...
                    if( maskId ){
                        ...
                        // }else{
                        //     console.log('uploadFile setBackgroundUrl data1');
                        //     $scope.setBackgroundUrl(data.src);
                        //     $timeout(function(){
                        //         $scope.toggleStageLoading();
                        //     });
                        // }
                        ...
                        // }else{
                        //     console.log('uploadFile setBackgroundUrl data2');
                        //     $scope.setBackgroundUrl(data.src);
                        //     $timeout(function(){
                        //         $scope.toggleStageLoading();
                        //     });
    ...
    $scope.storeBackgroundFile = function(data, name){
        console.log('[app-modern.min.js] storeBackgroundFile data: ', data, ' name: ', name);
        ...
        $scope._localStorage.save('nbdbackground');
...
/*         var _canvas = this.stages[stage_id]['canvas'];
    ...
    $scope.setBackgroundFile = function(file) {
        console.log('setBackgroundFile file', file);
        console.log('setBackgroundFile background: ', $scope.resource.background);
        ...
        NBDDataFactory.get('nbdesigner_customer_upload', {file: file}, function(data){
            ...
            if( data.flag == 1 ){
                ...
                // todo
                data.name = file.name;
                $scope.storeBackgroundFile(data, data.name);
                ...
                $scope.setBackgroundInner(url);
                $scope.toggleStageLoading();
                console.log('setBackgroundFile done data length: ', $scope.resource.background.data.length);
            }
        });
        //$scope.resource.upload.data.
