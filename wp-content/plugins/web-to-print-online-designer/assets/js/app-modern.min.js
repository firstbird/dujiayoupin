...
nbdApp.controller('designCtrl', 
    ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', 'filterBackgroundFilter', 'filterShapeFilter', 'filterIconFilter', '$timeout', '$http', '$document', '$interval',
    function($scope, FabricWindow, $window, NBDDataFactory, filterFontFilter, filterArtFilter, filterBackgroundFilter,
        filterShapeFilter, filterIconFilter,
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    if (response.data.length !== 0) {
                        ...
                        console.log('loadOSSFiles444 response after --- token:', $scope.resource[type].ossNextToken);
                        $scope.resource.paint.filteredPaints = $scope.filterPaintFilter($scope.resource[type].data, $scope.resource[type].filter);
