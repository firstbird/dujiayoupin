...
nbdApp.controller('designCtrl', 
    ...
    $scope.initSettings = function(){
        ...
        //     $scope.resource.paint.filtered = filterPaintFilter($scope.resource.paint.data, $scope.resource.paint.filter);
    ...
    $scope.filterPaintFilter = function(reses, filter) {
            console.log('filter55 res --- reses:', reses);
            console.log('filter55 res --- filter:', filter);
    ...
    $scope.openSubPage = function(type) {
        ...
        $scope.subPageSearch = '';
        console.log('openSubPage set subpage --- type:', type);
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    if (response.data.length !== 0) {
                        ...
                        //$scope.resource.paint.filtered = $scope.filterPaintFilter($scope.resource[type].data, $scope.resource[type].filter);
