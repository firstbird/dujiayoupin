...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', 'filterBackgroundFilter', '$timeout', '$http', '$document', '$interval',
    ...
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            background: {filter: {perPage: 10, currentPage: 1, totalPage: 10}, data: [], onload: false, init: true, ilr: false, progressBar: 0, ossNextToken: '', filteredBackground: []},
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    jQuery(container + ' .loading-photo').hide();
                    // var _data = JSON.parse(data);
                    if (response.data.nextToken !== $scope.resource[type].ossNextToken) {
                        // 追加新数据
