...
/*                 if( angular.isDefined( data.area ) ){
    ...
    /* Upload Image */
    $scope.uploadFile = function(files, indexFile, isBackground = false){
        ...
        if( file.type.indexOf("svg") > -1 ){
            ...
            reader.onload = function(event){
                if (event.target.readyState === 2) {
                    var result = reader.result;
                    console.log('uploadFile addSvgFromString file', file);
                    $scope.addSvgFromString(result);
                    console.log('uploadFile addSvgFromString result', result);
                ...
                if( data.flag == 1 ){
                    ...
                    if( maskId ){
                        if( !isBackground ){
                            ...
                            $scope.addBackgroundImage(data.src);
                            $timeout(function(){
                                $scope.toggleStageLoading();
                            });
                        }
...
/*         var _canvas = this.stages[stage_id]['canvas'];
    ...
    $scope.addBackgroundImage = function(url) {
