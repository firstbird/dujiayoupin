...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', 'filterBackgroundFilter', 'filterShapeFilter', 'filterIconFilter', 'filterPaintFilter', '$timeout', '$http', '$document', '$interval',
    function($scope, FabricWindow, $window, NBDDataFactory, filterFontFilter, filterArtFilter, filterBackgroundFilter, filterShapeFilter, filterIconFilter, filterPaintFilter, $timeout, $http, $document, $interval) {
    $scope.stages = [];
    var d = new Date(),
    t = d.getTime();
    ...
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            background: {filter: {perPage: 10, currentPage: 1, totalPage: 20}, data: [], onload: false, init: true, ilr: false, progressBar: 0, ossNextToken: '', hasMore: 'true', filteredBackgrounds: []},
            element: {onclick: false, onload: false, contentSearch: ''},
            shape: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true},
            icon: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true},
            paint: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true},
        ...
        $scope.iconList = [
            { type: 'icon1', name: 'icon1', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/icons/icon_default_1.png' },
            { type: 'icon2', name: 'icon2', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/icons/icon_default_2.png' },
            { type: 'icon3', name: 'icon3', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/icons/icon_default_3.png' },
            { type: 'icon4', name: 'icon4', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/icons/icon_default_4.png' },
            { type: 'icon5', name: 'icon5', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/icons/icon_default_5.png' },
            { type: 'icon6', name: 'icon6', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/icons/icon_default_6.png' }
        ];
        $scope.paintList = [
            { type: 'paint1', name: 'paint1', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_1.png' },
            { type: 'paint2', name: 'paint2', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_2.png' },
            { type: 'paint3', name: 'paint3', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_3.png' },
            { type: 'paint4', name: 'paint4', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_4.png' },
            { type: 'paint5', name: 'paint5', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_5.png' },
            { type: 'paint6', name: 'paint6', icon: '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_6.png' }
        ];
        ...
        $scope.$watchCollection('resource.background.filter', function(newVal, oldVal){
            ...
            $scope.resource.background.filteredBackgrounds = filterBackgroundFilter($scope.resource.background.data, $scope.resource.background.filter);
            console.log('resource.background.filteredBackgrounds ------', $scope.resource.background.filteredBackgrounds);
        ...
        $scope.$watchCollection('resource.paint.filter', function(newVal, oldVal){
            ...
            console.log('filterPaintFilter newVal ------', newVal, ' oldVal ------', oldVal);
            $scope.resource.paint.filteredPaints = filterPaintFilter($scope.resource.paint.data, $scope.resource.paint.filter);
            console.log('resource.paint.filteredPaints ------', $scope.resource.paint.filteredPaints);
        }, true);
        ...
        $scope.$watch('resource.background', function(newVal) {
            ...
            console.log('watch filteredBackgrounds:', newVal.filteredBackgrounds);
    ...
    $scope.openSubPage = function(type) {
        ...
        $scope.subPageSearch = '';
        console.log('openSubPage begin --- type:', type);
        if(type === 'shape') {
...
/*                 if( angular.isDefined( data.area ) ){
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    if (response.data.length !== 0) {
                        ...
                        console.log('loadOSSFiles response after --- token:', $scope.resource[type].ossNextToken);
                        $scope.$apply();
                    }
    ...
    $scope.renderMasonryList = function(type, container, item, scrollContainer, init){  
        ...
        if (type == 'icon' || type == 'shape' || type == 'paint') {
            ...
            console.log('renderMasonryList begin-- containerscrollTop: ', document.querySelector('.' + type + '-subpage-content'));
            $scope.bindIconScrollEvent(type);
        }
        if (type == 'clipart') {
        ...
        imagesLoaded( jQuery(container), function() {
            ...
            //     // 先移除旧的特殊处理
            //     jQuery(container).find('.masonry-last-row').removeClass('masonry-last-row').css('left', '');
            //     // 处理最后一行左对齐
            //     if( $scope.resScrollContainer ) {
            //         // console.log('renderMasonryList layoutComplete scope.scrollTop: ', $scope.resource[type]. subPageScrollTop, ' currentPage: ', $scope.resource[type].filter.currentPage);
            //         //$scope.resScrollContainer.scrollTop = $scope.resource[type]. subPageScrollTop;
            //         // document.querySelector('.icon-subpage-content').scrollTop = $scope.resource[type]. subPageScrollTop;
            //         //$scope.resScrollContainer.scrollTo(0, $scope.resource[type]. subPageScrollTop);
            //         // console.log('renderMasonryList layoutComplete containerscrollTop: ', document.querySelector('.icon-subpage-content').scrollTop);
            //         $scope.alignLastRowLeft(container, item);
            //     }
            // });
            $grid.masonry('layout');
            ...
            if (type === 'icon' || type === 'shape' || type === 'paint') {
                document.querySelector('.' + type + '-subpage-content').scrollTop = $scope.resource[type].subPageScrollTop;//document.querySelector('.icon-subpage-content').scrollHeight;
            }
            var count = 0;
    ...
    // 绑定图标页面的滚动事件
    $scope.bindIconScrollEvent = function(type) {
        var scrollContainer = document.querySelector('.' + type + '-subpage-content');
    ...
    $scope.scrollLoadMore = function(container, type){
        ...
        if( type == 'background' || type == 'icon' || type === 'shape' || type === 'paint'){
...
nbdApp.filter("filterPaint", function() {
    return function(reses, filter) {
        console.log('filter res --- reses:', reses);
        console.log('filter res --- filter:', filter);
