...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document', '$interval',
    ...
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            background: {filter: {perPage: 10, currentPage: 1, total: 3, totalPage: 10}, data: [], onload: false, init: true, ilr: false, progressBar: 0},
        ...
        $scope.$watchCollection('resource.background.filter', function(newVal, oldVal){
            ...
            $scope.resource.background.filteredArts = filterArtFilter($scope.resource.background.data.arts, $scope.resource.background.filter);
            if(newVal.search != oldVal.search){
                $timeout(function() {
                    jQuery("#tab-svg .tab-scroll").stop().animate({
                        scrollTop: 0
