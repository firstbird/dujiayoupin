...
/*                 if( angular.isDefined( data.area ) ){
    ...
    $scope.loadOSSFiles = function(type = '', container = '', callback) {
        ...
        console.log('loadOSSFiles token----', $scope.resource[type].ossNextToken);
        console.log('loadOSSFiles hasMore----', $scope.resource[type].hasMore);
        jQuery.ajax({
            url: NBDESIGNCONFIG['ajax_url'],
            method: "POST",
            data: {
            ...
            success: function(response) {
                console.log('PhotoAlbum: 加载OSS文件成功', response);
                if (response.success) {
                    jQuery(container + ' .loading-photo').hide();
                    // var _data = JSON.parse(data);
    ...
    $scope.renderMasonryList = function(type, container, item, scrollContainer, init){  
        ...
        imagesLoaded( jQuery(container), function() {
            ...
            console.log('renderMasonryList count: ', count);
        });
    };
    /* Infinite scroll */
    $scope.scrollLoadMore = function(container, type){
        console.log('scrollLoadMore type: ', type, ' container: ', container);
