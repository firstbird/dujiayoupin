...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', 'filterBackgroundFilter', '$timeout', '$http', '$document', '$interval',
    ...
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            background: {filter: {perPage: 10, currentPage: 1, totalPage: 10}, data: [], onload: false, init: true, ilr: false, progressBar: 0, ossNextToken: '', hasMore: 'true', filteredBackground: []},
        ...
        $scope.$watchCollection('resource.background.filter', function(newVal, oldVal){
            ...
            $scope.resource.background.filteredBackground = filterBackgroundFilter($scope.resource.background.data, $scope.resource.background.filter);
            if(newVal.search != oldVal.search){
                $timeout(function() {
                    jQuery("#tab-svg .tab-scroll").stop().animate({
                        scrollTop: 0
        ...
        $scope.$watch('resource.background', function(newVal) {
            ...
            console.log('watch filteredBackground:', newVal.filteredBackground);
