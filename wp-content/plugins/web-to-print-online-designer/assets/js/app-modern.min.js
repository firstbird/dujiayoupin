...
// 获取基础URL路径
const nbd_content_url = NBDESIGNCONFIG.nbd_content_url;  // 指向 wp-content/uploads/nbdesigner

// 获取设计图目录
const designs_url = nbd_content_url + '/designs';

// 示例：获取特定设计的预览图
const getDesignPreview = (design_folder) => {
    return designs_url + '/' + design_folder + '/preview';
};
...
nbdApp.controller('designCtrl', 
    ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', 'filterBackgroundFilter', '$timeout', '$http', '$document', '$interval',
    function($scope, FabricWindow, $window, NBDDataFactory, filterFontFilter, filterArtFilter,filterBackgroundFilter,
        $timeout, $http, $document, $interval) {
    $scope.stages = [];
    var d = new Date(),
    t = d.getTime();
    $scope.defaultStageStates = {
        ...
        text: {
            fontFamily: {
                ...
                r: NBDESIGNCONFIG.default_font.file && NBDESIGNCONFIG.default_font.file.r ? NBDESIGNCONFIG.default_font.file.r : '',
                b: NBDESIGNCONFIG.default_font.file && NBDESIGNCONFIG.default_font.file.b ? NBDESIGNCONFIG.default_font.file.b : '',
                i: NBDESIGNCONFIG.default_font.file && NBDESIGNCONFIG.default_font.file.i ? NBDESIGNCONFIG.default_font.file.i : '',
                bi: NBDESIGNCONFIG.default_font.file && NBDESIGNCONFIG.default_font.file.bi ? NBDESIGNCONFIG.default_font.file.bi : ''
            },
            fontSize: 14,
    ...
    // $scope.resource[type].subPageScrollTop = 0;
    // $scope.resource[type].isSubPageFirstIn = true;
    $scope.defaultConfig = {
        name: 'Typography',
        width: 200,
        height: 200,
    ...
    $scope.defaultElementPath = '/wp-content/plugins/web-to-print-online-designer/assets/images/default/';
    $scope.adapt_menu_position = function(){
        const allZoomToolbars = document.querySelectorAll('.nbd-toolbar-zoom');
        allZoomToolbars.forEach(toolbarZoom => {
            // 对每个元素进行操作
            if (toolbarZoom) {
                // 计算窗口宽度的1/8
                var rate = 8;
                ...
                const rightValue = window.innerWidth / rate;
                toolbarZoom.style.position = 'fixed'; // 确保定位生效
                toolbarZoom.style.right = `${rightValue}px`;
                toolbarZoom.style.transition = 'right 0.3s ease';
                // console.log('Set .nbd-toolbar-zoom right to:', rightValue);
            }
        });
        // const toolbarZoom = document.querySelector('.nbd-toolbar-zoom');
    }
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            background: {filter: {perPage: 10, currentPage: 1, totalPage: 20}, data: [], onload: false, init: true, ilr: false, progressBar: 0, ossNextToken: '', hasMore: 'true', filtered: []},
            element: {onclick: false, onload: false, contentSearch: ''},
            shape: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '形状'},
            icon: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '图标'},
            paint: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '插画'},

            character: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '人物'},
            pet: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '宠物'},
            chineseStyle: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '中国风'},
            promotion: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '促销'},
            food: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '食物'},
            material: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '材质'},
            cute: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '可爱'},
            emoticon: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '表情包'},
            textBox: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '文本框'},
            plant: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '植物'},
            music: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '音乐'},
            celestialBody: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '天体'},
            starrySky: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '星空'},
            weather: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '天气'},
            game: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '游戏'},
            cartoon: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '卡通'},
            scenery: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '涂鸦'},
            fruit: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '水果'},
            flower: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '花卉'},
            blessing: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '祝福语'},
            fluid: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '流体'},
            animal: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '动物'},
            frame: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '线框'},
            line: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '线条'},
            dialogBox: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '对话框'},
            expression: {filter: {perPage: 30, currentPage: 1, totalPage: 20, currentCat: null}, data: [], cat: [], init: true, onload: false, first: true, hasMore: 'true', subPageScrollTop: 0, isSubPageFirstIn: true, subPageTitle: '表情'},
        ...
        for (var key in $scope.resource) {
            var value = $scope.resource[key];
            if (value.hasOwnProperty('subPageTitle')) {
                $scope.defaultElements[key] = [];
                for (let i = 1; i <= 6; i++) {
                    $scope.defaultElements[key].push($scope.defaultElementPath + key + '/' + key + '_default_' + i + '.png');
                }
            }
        }
        // $scope.defaultElements = {
        //     shape: ['/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_1.png',
        //         '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_2.png',
        //         '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_3.png',
        //         '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_4.png',
        //         '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_5.png',
        //         '/wp-content/plugins/web-to-print-online-designer/assets/images/paints/paint_default_6.png'
        //     ],
        console.log('init setting background0: ', $scope.resource.background);
        console.log('init setting upload: ', $scope.resource.upload);
        ...
        // 添加新增的本地字体到资源数据中
        // 从typo.json文件动态读取本地字体数据
        var newLocalFonts = [];
        
        // 异步加载typo.json文件
        jQuery.ajax({
            url: '/wp-content/plugins/web-to-print-online-designer/data/typography/typo.json',
            type: 'GET',
            dataType: 'json',
            async: false, // 同步加载，确保字体数据在后续代码执行前可用
            success: function(data) {
                console.log('✅ 成功加载typo.json文件，字体数量:', data.length);
                
                // 将typo.json数据转换为字体对象格式
                newLocalFonts = data.map(function(item) {
                    return {
                        alias: item.name.toLowerCase().replace(/\s+/g, ''), // 转换为小写并移除空格
                        name: item.name,
                        url: '/wp-content/plugins/web-to-print-online-designer/assets/fonts/' + item.name.toLowerCase().replace(/\s+/g, '') + '.ttf',
                        type: 'local',
                        cat: ['0'],
                        subset: item.language === 'chinese' ? 'chinese' : 'latin',
                        folder: item.folder,
                        language: item.language
                    };
                });
                
                console.log('✅ 转换后的字体数据:', newLocalFonts);
            },
            error: function(xhr, status, error) {
                console.log('⚠️ 加载typo.json失败，使用默认字体数据:', error);
        ...
        newLocalFonts.forEach(function(font) {
            if(!_.filter($scope.resource.font.data, ['alias', font.alias]).length){
                ...
                console.log('新增字体已添加到资源数据:', font.alias);
            }
        });
        ...
        console.log('NBDESIGNCONFIG nbdesigner_enable_clipart', $scope.settings.nbdesigner_enable_clipart);
        ...
        $scope.$watchCollection('resource.clipart.filter', function(newVal, oldVal){
            console.log('resource.clipart.filter ------', $scope.resource.clipart.filter);
        ...
        $scope.$watchCollection('resource.background.filter', function(newVal, oldVal){
            console.log('resource.background.filter ------', $scope.resource.background.filter);
            console.log('resource.background.data ------', $scope.resource.background.data);
            console.log('filterBackgroundFilter newVal ------', newVal, ' oldVal ------', oldVal);
            $scope.resource.background.filtered = filterBackgroundFilter($scope.resource.background.data, $scope.resource.background.filter);
            console.log('resource.background.filtered ------', $scope.resource.background.filtered);
            if(oldVal && newVal && newVal.search != oldVal.search){
                $timeout(function() {
                    jQuery("#tab-svg .tab-scroll").stop().animate({
                        scrollTop: 0
                    }, 100);
        ...
        for (var res_type in $scope.resource) {
            
            var value = $scope.resource[res_type];
            if (value.hasOwnProperty('subPageTitle')) {
                watched_resources.push(res_type);
            }
        }
        console.log('init setting watched_resources: ' + watched_resources);
        // watched_resources.forEach((wtype, index) => {
        //     var watch_filter = 'resource.'+ wtype + '.filter.search';
        //     console.log('watchCollection init settings wtype ------', wtype, ' watch_filter: ', watch_filter);

        //     $scope.$watchCollection(watch_filter, function(newVal, oldVal){
        //         console.log('watchCollection resource.filter watch_filter: ' + watch_filter);
        //         console.log('watchCollection resource.filter ------', $scope.resource[wtype].filter);
        //         console.log('watchCollection resource.data ------', $scope.resource[wtype].data);
        //         console.log('watchCollection filter2 newVal ------', newVal, ' oldVal ------', oldVal);
        //         // const loading_span = document.querySelector('.loading-indicator');
        //         // if (newVal != oldVal) {
        //         //     if (loading_span) loading_span.innerHTML = '';
        //         // }
        //         // if (newVal === '') {
        //         //     if (loading_span) {
        //         //         if ($scope.isLoadingMoreResources) {
        //         //             loading_span.innerHTML = '正在加载更多';
        //         //         } else {
        //         //             loading_span.innerHTML = '已经到底部了';
        //         //         }
        //         //     }
        //         // }
        //         console.log('watchCollection wtype: ', wtype, ' onload: ', $scope.resource[wtype].onload, ' hasMore: ', $scope.resource[wtype].hasMore);
        //         // if ($scope.resource[wtype].hasMore === 'true') {
        //         //     //todo search
        //         // }
        //         $scope.searchOSSFiles(wtype, newVal, function(newVal, oldVal){
        //             // $scope.resource[wtype].filtered = $scope.filterElement($scope.resource[wtype].data, $scope.resource[wtype].filter);
        //             // console.log('resource.shape.filteredShapes ------', $scope.resource.shape.filtered);
        //             $scope.onEndRepeat(wtype);
        //         });

        //     }, true);
        // });

        // $scope.$watchCollection('resource.shape.filter', function(newVal, oldVal){
        //     console.log('resource.shape.filter ------', $scope.resource.shape.filter);
        //     console.log('resource.shape.data ------', $scope.resource.shape.data);
        //     console.log('filterShapeFilter newVal ------', newVal, ' oldVal ------', oldVal);
        //     $scope.resource.shape.filteredShapes = filterShapeFilter($scope.resource.shape.data, $scope.resource.shape.filter);
        //     console.log('resource.shape.filteredShapes ------', $scope.resource.shape.filteredShapes);
        //     $scope.onEndRepeat('shape');
        // }, true);
        // $scope.$watchCollection('resource.icon.filter', function(newVal, oldVal){
        //     console.log('resource.icon.filter ------', $scope.resource.icon.filter);
        //     console.log('resource.icon.data ------', $scope.resource.icon.data);
        //     console.log('filterShapeFilter newVal ------', newVal, ' oldVal ------', oldVal);
        //     $scope.resource.icon.filteredIcons = filterIconFilter($scope.resource.icon.data, $scope.resource.icon.filter);
        //     console.log('resource.icon.filteredIcons ------', $scope.resource.icon.filteredIcons);
        // }, true);
        // $scope.$watchCollection('resource.paint.filter', function(newVal, oldVal){
        //     console.log('resource.paint.filter ------', $scope.resource.paint.filter);
        //     console.log('resource.paint.data ------', $scope.resource.paint.data);
        //     console.log('paint Filter newVal ------', newVal, ' oldVal ------', oldVal);
        //     // $scope.resource.paint.filtered = filterElement($scope.resource.paint.data, $scope.resource.paint.filter);
        //     console.log('resource.paint.filtered ------', $scope.resource.paint.filtered);
        // }, true);
        ...
        $scope.adapt_menu_position();
        $scope.settings.nbes_settings = {
            combination_colors: {
                bg_codes: [
                    '#222222', '#444444', '#888888', '#cccccc', '#eeeeee', '#666666',
                    '#111111', '#b3e5fc', '#4fc3f7', '#1976d2', '#283593',
                    '#9575cd', '#7e57c2', '#512da8', '#6a1b9a', '#f06292', '#c2185b',
                    '#ffab91', '#e53935', '#b71c1c', '#ffd54f', '#ffb300', '#ff8f00',
                    '#fbc02d', '#fff176', '#d4e157', '#388e3c', '#388e3c', '#43a047',
                    '#009688', '#26a69a', '#80cbc4', '#4dd0e1', '#00838f', '#006064'
                ],
                fg_codes: [
                    '#fff', '#fff', '#000', '#000', '#000', '#fff',
                    '#fff', '#000', '#000', '#fff', '#fff',
                    '#fff', '#fff', '#fff', '#fff', '#fff', '#fff',
                    '#000', '#fff', '#fff', '#000', '#000', '#000',
                    '#000', '#000', '#000', '#fff', '#fff', '#fff',
            ...
            background_colors: {
                ...
                names: [
                    'Black', 'Dark Gray', 'Gray', 'Light Gray', 'White', 'Gray',
        ...
        $scope.$watch('resource.clipart', function(newVal) {
            console.log('clipart data:', newVal);
            console.log('filteredArts:', newVal.filteredArts);
            console.log('currentPage:', newVal.filter.currentPage);
            console.log('perPage:', newVal.filter.perPage);
            console.log('total:', newVal.filter.total);
            console.log('onload:', newVal.onload);
        }, true);

        $scope.$watch('resource.background', function(newVal) {
            console.log('watch background data:', newVal);
            console.log('watch filtered:', newVal.filtered);
            console.log('watch currentPage:', newVal.filter.currentPage);
            console.log('watch perPage:', newVal.filter.perPage);
            console.log('watch total:', newVal.filter.total);
            console.log('watch onload:', newVal.onload);
        }, true);
        console.log('init setting combination_colors: ', $scope.settings.nbes_settings.combination_colors);
        // $scope.initTooltip();
    };
    $scope.filterElement = function(reses, filter) {
            console.log('filterElement res --- reses:', reses);
            console.log('filterElement res --- filter:', filter);

            var filtered = [];
            reses = _.sortBy(reses, [function(o) { return o.key; }]);
            angular.forEach(reses, function(res, key) {
                console.log('filterElement res:', res, ' key', key);
                var check = [];
                check['limit'] = true;
                // check['limit'] = filtered.length > ( filter.perPage * filter.currentPage  - 1 ) ? false : true;
                // if( !!filter.search ){
                //     check['name'] = res.key.toLowerCase().indexOf(filter.search.toLowerCase()) >= 0 ? true : false;
                //     if( angular.isDefined( res.display_name ) && res.display_name != '' ){
                //         check['name'] = check['name'] || (res.display_name.toLowerCase().indexOf(filter.search.toLowerCase()) >= 0 ? true : false);
                //     }
                // }else{
                    check['name'] = true;
                // };
                if( check['limit'] && check['name'] )filtered.push(res);
            });
            console.log('filterElement filtered.length:', filtered.length);
            return filtered
    };
    $scope.getListByType = function(type) {
        return $scope.defaultElements[type];
    }
    // $scope.openPhotoAlbum = function() {
        // console.log('Opening photo album...'); // 添加调试日志
        // jQuery('#nbd-photo-album-modal').modal('show');
        // $scope.loadUserPhotos();
                // 触发自定义事件
        // jQuery(document).trigger('nbd:openPhotoAlbum');
    // };
    
    // $scope.loadUserPhotos = function() {
    //     console.log('Loading user photos...'); // 添加调试日志
    //     $scope.isLoadingPhotos = true;
    //     NBDDataFactory.get('nbdesigner_get_user_photos', {}, function(data) {
    //         console.log('Photos loaded:', data); // 添加调试日志
    //         data = JSON.parse(data);

    //         if (data.success) {
    //             $scope.userPhotos = data.photos || [];
    //         } else {
    //             console.error('Failed to load photos:', data.data.message);
    //         }
    //         $scope.isLoadingPhotos = false;
    //         // todo
    //         // $scope.$apply();
    ...
    $scope.setPhotoFile = function(file) {
        if (!file) return;
        console.log('Setting photo file:', file); // 添加调试日志
    ...
    $scope.selectPhoto = function(photo) {
        console.log('Selecting photo:', photo); // 添加调试日志
        $scope.addImage(photo.url, false, true);
        jQuery('#nbd-photo-album').modal('hide');
    };
    
    $scope.deletePhoto = function(photo) {
        if (!confirm('确定要删除这张图片吗？')) return;
        console.log('Deleting photo:', photo); // 添加调试日志
        
        NBDDataFactory.get('nbdesigner_delete_user_photo', {
            photo_id: photo.id
        }, function(response) {
            console.log('Delete response:', response); // 添加调试日志
            if (response.success) {
    ...
    $scope.init = function() {
        ...
        console.log('init NBDESIGNCONFIG:', NBDESIGNCONFIG);
        console.log('init nbd_window:', nbd_window.NBDESIGNERPRODUCT);
        if(typeof nbd_window.NBDESIGNERPRODUCT != 'undefined'){
            nbd_window.NBDESIGNERPRODUCT.hide_loading_iframe();
        } else {
            nbd_window.NBDESIGNERPRODUCT = {
                product_id: '',
                variation_id: '',
                folder: '',
                design_images: [],
                
                show_design_thumbnail: function(images, task) {
                    console.log('Show design thumbnail:', images, task);
                    if (images && images.length > 0) {
                        jQuery('.nbd-artwork-preview-wrap').empty();
                ...
                get_sugget_design: function(product_id, variation_id) {
                    console.log('Get suggest design:', product_id, variation_id);
                }
            };
        };
    ...
    $scope._localStorage = {
        save: function(type, value){
            ...
            if( type == 'nbdbackground') {
                if( $scope.resource.background.data.length > 20 ) $scope.resource.background.data.shift();
                value = JSON.stringify($scope.resource.background.data);
            }
        ...
        delete: function(type){
            ...
            if( type == 'nbdbackground') {
                $scope.resource.background.data = [];
                $scope.updateApp();
            }
    ...
    // $scope.isLoadingMoreResources = true;
    $scope.subPageType = '';
    $scope.subPageTitle = '';
    $scope.subPageSearch = '';
    $scope.iconSubGroups = [
    ...
    $scope.openSubPage = function(type) {
        ...
        $scope.subPageSearch = "";//"resource." + type + ".filter.search";;
        console.log('openSubPage set subpage --- type:', $scope.subPageSearch);
        $scope.subPageTitle = $scope.resource[type].subPageTitle;
        // if(type === 'shape') {
        ...
        // }
        $scope.loadOSSFiles(type);

        console.log('openSubPage done --- type:', type);
        // if(type === 'shape' || type === 'icon') {
        //     // $scope.subPageTitle = '形状';
        //     $scope.loadOSSFiles(type);
        //     //$scope.getMedia('shape');
        //     // $scope.onClickTab('shape', 'element');
        //     // $scope.renderMasonryList('shape', '#nbd-shape-wrap .mansory-wrap', '.mansory-item', '#nbd-shape-wrap', $scope.resource.shape.init);
        //     // $scope.resource.shape.data = $scope.resource.shape.data.filter(function(item){ return item.type === 'shape'; });
        ...
        // } else if(type === 'paint') {
        //     $scope.subPageTitle = '插画';
        //     // 这里需要将 resource.paint.data 按"卡通/手绘"分组
        //     $scope.paintSubGroups[0].items = $scope.resource.paint.data.filter(function(item){ return item.category === '卡通'; });
        //     $scope.paintSubGroups[1].items = $scope.resource.paint.data.filter(function(item){ return item.category === '手绘'; });
        // }
    };
    $scope.closeSubPage = function() {
        $scope.showSubPage = false;
        if ($scope.resScrollContainer != null) {
            $scope.resScrollContainer.removeEventListener('scroll', $scope.handleResScroll);
            //jQuery('#nbd-icon-wrap .mansory-wrap').masonry('destroy');
            // $scope.resScrollContainer.masonry('destroy');
            console.log('closeSubPage resScrollContainer: ', $scope.resScrollContainer);

            var contentItem = $scope.resScrollContainer.querySelector('.content-item');
            var type = '';
            if (contentItem) {
                type = contentItem.getAttribute('data-type');
            }

            jQuery('#nbd-'+type+'wrap .mansory-wrap').masonry('destroy');
            console.log('closeSubPage mansory success');
            $scope.resource[type].isSubPageFirstIn = false;
            $scope.resScrollContainer = null;
        }
    };
    ...
    /* Get Data */
    // only in init -> NBDDataFactory.get('nbd_get_resource',
    $scope.getResource = function(type, container, callback){
        console.log('getResource --- type:', type, 'container:', container, 'callback:', callback);
        // if (type == 'background') {
        //     $scope.getMedia('icon');
        //     return;
        // }
        ...
        console.log('getResource --- type:', type, ' loading-photo show');
        jQuery(container + ' .loading-photo').show();
        
        // // 如果是 typography 类型，先添加本地 typography 数据
        // if (type == 'typography') {
        //     var localTypographyData = [];
        //     for (var i = 1000; i < 1050; i++) {
        //         localTypographyData.push({
        //             id: i,
        //             folder: String(i),
        //             name: 'Local Typography ' + i,
        //             language: 'chinese',
        //             url: 'https://dujiayoupin.com/wp-content/plugins/web-to-print-online-designer/data/typography/local/' + i + '/preview.png'
        //         });
        //     }
        //     $scope.resource[type].data = localTypographyData;
        //     console.log('getResource --- 已添加本地 typography 数据，数量:', localTypographyData.length);
        // }
        ...
        NBDDataFactory.get('nbd_get_resource', {type: post_type, task: $scope.settings.task}, function(data){
            jQuery(container + ' .loading-photo').hide();
            console.log('getResource nbd_get_resource data: ', data, 'type: ', type);
            ...
            // 对于 typography 类型，合并本地数据和远程数据
            // if (type == 'typography') {
            //     var remoteData = _data.data || [];
            //     var localData = $scope.resource[type].data || [];
            //     $scope.resource[type].data = localData.concat(remoteData);
            //     console.log('getResource --- typography 数据合并完成，本地数据:', localData.length, '远程数据:', remoteData.length, '总计:', $scope.resource[type].data.length);
            // } else {
            $scope.resource[type].data = _data.data;
            // }
            
            console.log('getResource response --- type:', type, ' data:', $scope.resource[type].data, ' length:', $scope.resource[type].data.length);
            console.log('getResource response before --- filter:', $scope.resource[type].filter);
            $scope.resource[type].filter.total = $scope.resource[type].data.length;
            console.log('getResource response after --- filter:', $scope.resource[type].filter);
            if( callback ) $scope.afterGetResource(type);
        });
    };
    $scope.onClickTab = function(type, tab){
        console.log('onClickTab --- type:', type, 'tab:', tab, 'trace:', console.trace());
        ...
        console.log('app-modern onClickTab --- type:', type);
        switch(type){
            case 'dropbox':
            case 'facebook':
            case 'instagram':
            ...
            case 'background':
                ...
                if( type == 'background' ){
                    if( $scope.resource.background.data.length == 0){
                        console.log('onClickTab nbdbackground --- ');
                        $scope.resource.background.data = $scope._localStorage.get('nbdbackground');
                    };
                };
                $timeout(function(){
            ...
            if(fonts.length){
                _.each(fonts, function(font, index){
                    ...
                    if( !jQuery('#' + font_id).length ){
                        // mzl mod jQuery('head').append('<link id="' + font_id + '" href="https://fonts.googleapis.com/css?family='+ font.name.replace(/\s/gi, '+') +':400,400i,700,700i" rel="stylesheet" type="text/css">');
                    }
                });
            }
    ...
    $scope.getMedia = function(type, context){
        console.log('getMedia type: ', type);
        ...
        switch( type ){
            ...
            case 'storyset':
                ...
                break;
            default:
                var url = appConfig.mediaUrl + '/clipart?limit=20&category=' + category + '&search=' + search + '&start=' + ($scope.resource[type].filter.currentPage-1) * 20;
                console.log('getMedia default url: ', url, ' type: ', type);
                $http({
                    method: 'GET',
                    url: url
                }).then(function successCallback(response){
                    console.log('getMedia default success: ', type, $scope.resource[type]);
    ...
    $scope.getPhoto = function(type, context){ 
        console.log('#tab-photo getPhoto --- type:', type);
        ...
        console.log('#tab-photo getPhoto2 --- ');
            ...
            switch(type){
                ...
                case 'Freepik':
                    ...
                    $http({
                        ...
                        var data = response.data,
                        totalPage = data.images.length;
                        $scope.resource.photo.filter.totalPage = totalPage > 10 ? 10 : totalPage;
                        _.each(data.images, function(val, key) {
                            $scope.resource.photo.data.push({
                                extenal: 1,
                                url: val.url,
                                preview: val.preview,
    ...
    $scope.getPersonalPhoto = function(type, dataObj){
        jQuery('#tab-photo .loading-photo').show();
        console.log('getPersonalPhoto --- type:', type);
        switch(type){
            case 'dropbox':
    ...
    $scope.afterGetResource = function(type){
        console.log('afterGetResource begin --- type:', type, ' resource:', $scope.resource[type]);
        switch(type){
            case 'clipart':
                ...
                break;
            case 'photo':
                console.log('afterGetResource photo.data', $scope.resource.photo.data);
                ...
                break;
            case 'background':
                console.log('afterGetResource background.data', $scope.resource.background.data);
                if( $scope.resource.background.data.length == 0 ) jQuery('#tab-background .loading-background').hide();
                console.log('afterGetResource background.filter', $scope.resource.background.filter);
                console.log('afterGetResource background.filter.total', $scope.resource.background.filter.total);
                console.log('afterGetResource background.filter.totalPage', $scope.resource.background.filter.totalPage);
                console.log('afterGetResource background.filter.perPage', $scope.resource.background.filter.perPage);
                $scope.resource.background.filter.total = $scope.resource.background.filter.totalPage * $scope.resource.background.filter.perPage;
                console.log('afterGetResource after background.filter.total', $scope.resource.background.filter.total);
                break;
        }
        console.log('afterGetResource end --- type:', type, ' total:', $scope.resource[type].filter.total, ' total2: ', $scope.resource.background.filter.total);
...
/*                 if( angular.isDefined( data.area ) ){
    ...
    $scope.changeVariation = function(){
        console.log('[app-modern.min.js] changeVariation');
        if( $scope.onloadVariation ) return;
        if( angular.isDefined( NBDESIGNCONFIG.force_hide_option ) && NBDESIGNCONFIG.nbdesigner_display_product_option == '1' ) {
            return;
        }
        ...
        $scope.preventChangeCurrentDesign = true;
        $scope.needLoadVariationDesign();
        console.log('[app-modern.min.js] changeVariation nbdesigner_get_product_info');
    ...
    $scope.showProducts = function(){
        ...
        NBDDataFactory.get('nbd_get_nbd_products', {}, function(data){
            ...
            if( _data.length && angular.isDefined( _data[0].product_id ) ){
                console.log("showProducts _data ----", _data);
    ...
    $scope.getProductInfo = function(){
        ...
        NBDDataFactory.get('nbd_get_product_description', {product_id: NBDESIGNCONFIG.product_id}, function(data){
            var _data = JSON.parse( data );
            console.log('getProductInfo show2DPreview _data', _data);
            jQuery('.nbd-popup.popup-nbd-products').find('.overlay-main').removeClass('active');
        });
    };
    ...
    $scope.uploadFile = function(files, indexFile){
        console.log('[app-modern.min.js] uploadFile', files, indexFile);
        console.log('uploadFile photo1 data', $scope.resource.photo.data);
        ...
        if( file.type.indexOf("svg") > -1 ){
            ...
            NBDDataFactory.get('nbdesigner_customer_upload', {file: file}, function(data){
                ...
                if( data.flag == 1 ){
                    ...
                    console.log('uploadFile1 data', data);
                    $scope.storeUploadFile(data, data.name);
                    if( maskId ){
                        console.log('uploadFile1 maskId', maskId);
                        $scope.addImage(data, false, true, false, false, maskId);
                    }else{
                        console.log('uploadFile2 maskId', maskId);
                        $scope.addImage(data, false, true );
                    }
                    console.log('uploadFile show image data', data);
                    jQuery("#tab-photo .tab-scroll").stop().animate({
                ...
                console.log('uploadFile photo2 data', $scope.resource.photo.data);
            }, function( progress ){
                // todo
    ...
    $scope.storeBackgroundFile = function(data, name, type){
        console.log('[app-modern.min.js] storeBackgroundFile data: ', data, ' name: ', name, ' type: ', type);
        var src = typeof data == 'object' ? data.src : data;
        var ojb = {
            url: src,
            src: src,
            des: name,
            ilr: $scope.resource.background.ilr
        };
        ...
        $scope.resource.background.data.push( ojb );

        $scope._localStorage.save(type);
        console.log('storeBackgroundFile done length: ', $scope.resource.background.data.length, ' ojb: ', ojb);
    };
    $scope.storeUploadFile = function(data, name){
        console.log('[app-modern.min.js] storeUploadFile data: ', data, ' name: ', name);
        var src = typeof data == 'object' ? data.src : data;
        var ojb = {
            url: src,
            src: src,
    ...
    $scope.toggleStageLoading = function( timeout ){
        ...
        if( jQuery('.loading-workflow').hasClass('nbd-show') ){
            ...
            // 只有在明确指定超时时间时才启用自动超时机制
            // 对于字体加载，我们不使用自动超时，而是手动控制
            if( timeout && timeout > 0 ){
                $scope._promise = $timeout(function(){
                    if( $scope.stageOnload ){
                        ...
                        console.log('⏰ loading自动超时隐藏');
                    }
                }, _timeout);
            } else {
                console.log('🔧 loading显示，不启用自动超时');
            }
        }else{
    ...
    // 全局搜索功能
    $scope.performGlobalSearch = function() {
        var searchTerm = $scope.globalSearchTerm;
        if (!searchTerm || searchTerm.trim() === '') {
            return;
        }
        
        console.log('执行全局搜索:', searchTerm);
        jQuery.ajax({
            url: NBDESIGNCONFIG['ajax_url'],
            method: "POST",
            data: {
                action: 'nbd_oss_search_images',
            ...
            success: function(response) {
                console.log('nbd_oss_search_images [response]', response);
                if (response.success) {
                    // 显示搜索结果
                    $scope.showGlobalSearchResults(response.data.files, searchTerm);
                } else {
                    console.error('全局搜索失败:', response.data.message);
                }
            },
            error: function(xhr, status, error) {
                console.error('全局搜索请求失败:', error);
            }
        });
    };

    // 显示全局搜索结果
    $scope.showGlobalSearchResults = function(results, searchTerm) {
        // 创建搜索结果页面
        $scope.showSubPage = true;
        $scope.subPageType = 'globalSearch';
        $scope.subPageTitle = '搜索结果: ' + searchTerm;
        
        // 初始化全局搜索结果数据
        if (!$scope.resource.globalSearch) {
            $scope.resource.globalSearch = {
                filtered: [],
                all: [],
                filter: { search: '' }
            };
        ...
        // 更新搜索结果
        $scope.resource.globalSearch.filtered = results;
        $scope.resource.globalSearch.all = results;
    };
    ...
    // 添加OSS文件加载方法
    $scope.searchOSSFiles = function(type = '', searchKey = '', callback) {
        var self = this;

        // if ($scope.resource[type].hasMore === 'false') {
        //     return;
        // }
        // console.log('loadOSSFiles type: ', type, ' currentPage: ', $scope.resource[type].filter.currentPage, ' totalPage: ', $scope.resource[type].filter.totalPage);
        // if( $scope.resource[type].filter.currentPage >= $scope.resource[type].filter.totalPage ){
        //     return;
        // }

        // console.log('loadOSSFiles begin onload: ', $scope.resource[type].onload);
        // if( $scope.resource[type].onload ) return;
        // const threadId = getThreadId();
        // console.log(`[Thread ${threadId}] 开始执行scrollLoadMore`);
        
        // $scope.resource[type].onload = true;
        console.log('searchOSSFiles [request] set');
        // $scope.isLoadingMoreResources = true;
        jQuery.ajax({
            url: NBDESIGNCONFIG['ajax_url'],
            method: "POST",
            ...
            success: function(response) {
                console.log('searchOSSFiles [response]', response);
                if (response.success) {
                    // jQuery(container + ' .loading-photo').hide();
                    // var _data = JSON.parse(data);
                    if (response.data.length !== 0) {
                        // 追加新数据
                        $scope.resource[type].data = response.data.files;
                        // 更新nextToken
                        // if (response.data.hasMore === 'true' && response.data.nextToken !== "") {
                        //     $scope.resource[type].ossNextToken = response.data.nextToken;
                        // }
                        console.log('loadOSSFiles response --- type:', type, ' length:', $scope.resource[type].data.length);
                        $scope.resource[type].filter.total = $scope.resource[type].data.length;
                        // $scope.resource[type].filter.currentPage +=1;
                        if( callback ) $scope.afterGetResource(type);

                        console.log('loadOSSFiles666 response after --- token:', $scope.resource[type].ossNextToken);
                        //$scope.resource.paint.filtered = $scope.filterElement($scope.resource[type].data, $scope.resource[type].filter);
                        $scope.resource[type].filtered = $scope.resource[type].data;
                        callback();
                        $scope.$apply();
                        
                    }
                    $scope.resource[type].hasMore = response.data.hasMore;
                    $scope.resource[type].onload = false;
                } else {
                    $('#nbd-photo-grid').html('<div class="error">加载文件失败：' + response.data.message + '</div>');
                }
            },
            error: function(xhr, status, error) {
                console.error('PhotoAlbum: 加载OSS文件失败', error);
                $('#nbd-photo-grid').html('<div class="error">加载文件失败：' + error + '</div>');
            }
        });
    };
    ...
    $scope.performSearch = function(type) {
        if (!$scope.resource[type] || !$scope.resource[type].filter) {
            return;
        }
        
        var searchTerm = $scope.resource[type].filter.search;
        console.log('执行搜索:', type, searchTerm);
        
        $scope.searchOSSFiles(type, searchTerm, function(){
            // $scope.resource[wtype].filtered = $scope.filterElement($scope.resource[wtype].data, $scope.resource[wtype].filter);
            // console.log('resource.shape.filteredShapes ------', $scope.resource.shape.filtered);
            $scope.onEndRepeat(type);
        });
        
        // 示例：如果是本地过滤，可以这样处理
        // if ($scope.resource[type].all) {
        //     if (searchTerm && searchTerm.trim() !== '') {
        //         $scope.resource[type].filtered = $scope.resource[type].all.filter(function(item) {
        //             return item.name && item.name.toLowerCase().indexOf(searchTerm.toLowerCase()) !== -1;
        //         });
        //     } else {
        //         $scope.resource[type].filtered = $scope.resource[type].all;
        //     }
        // }
    };
    // 添加OSS文件加载方法
    $scope.loadOSSFiles = function(type = '', container = '', callback) {
        var self = this;
        ...
        $scope.resource[type].onload = true;
        console.log('loadOSSFiles [request] set onload: true token: ', $scope.resource[type].ossNextToken);
        // $scope.isLoadingMoreResources = true;
        jQuery.ajax({
            url: NBDESIGNCONFIG['ajax_url'],
            method: "POST",
            data: {
                action: 'nbd_oss_list_files',
                type: type,
                token: $scope.resource[type].ossNextToken,
                num: $scope.resource[type].filter.perPage
            },
            beforeSend: function() {
                $('#nbd-photo-grid').html('<div class="loading">加载中...</div>');
            },
            success: function(response) {
                console.log('loadOSSFiles [response]', response);
                if (response.success) {
                    // jQuery(container + ' .loading-photo').hide();
                    // var _data = JSON.parse(data);
                    if (response.data.length !== 0) {
                        // 追加新数据
                        $scope.resource[type].data = $scope.resource[type].data.concat(response.data.files);
                        // 更新nextToken
                        if (response.data.hasMore === 'true' && response.data.nextToken !== "") {
                            $scope.resource[type].ossNextToken = response.data.nextToken;
                        }
                    ...
                    $scope.resource[type].hasMore = response.data.hasMore;
                    $scope.resource[type].onload = false;
                    // var _data = response.data.files;
                    // $scope.resource[type].data = _data;
                    ...
                    //         .off('click')
                    //         .on('click', function() {
                    //             self.loadOSSFiles($scope.resource[type].ossNextToken);
                    //         });
                    // } else {
                    //     $('#nbd-load-more-files').hide();
                    // }
                } else {
                    $('#nbd-photo-grid').html('<div class="error">加载文件失败：' + response.data.message + '</div>');
                }
    ...
    $scope.onEndRepeat = function(type){
        console.log('onEndRepeat --- type:', type);
        switch(type){
            case 'typography':
    ...
    $scope.onSwitchDrawMode = function(){
        console.log('onSwitchDrawMode status: ', $scope.resource.drawMode.status);
        $scope.resource.drawMode.status = !$scope.resource.drawMode.status;
        _.each($scope.stages, function(stage, index){
            stage.canvas.isDrawingMode = !stage.canvas.isDrawingMode;
        });
        $scope.updateApp();
    };
    $scope.alignLastRowLeft = function(container, item) {
        ...
        $items.each(function() {
            ...
            if (top === maxTop) {
                lastRowItems.push($el);
            }
        });
    
        // 3. 依次排列最后一行元素
        // var left = 0;
        console.log('lastRowItems length: ', lastRowItems.length);
        if (lastRowItems.length % 3 != 0) {
            lastRowItems.forEach(function($el) {
                $el.css('display', 'none');
                console.log('lastRowItems: ', $el);
                // 获取元素宽度（含margin）
                // var width = $el.outerWidth(true);
                // // 只对最后一行加特殊class
                // $el.addClass('masonry-last-row');
                // // 重新设置left
                // $el.css('left', left + 'px');
                //     left += width;
                });
    ...
    $scope.currentTabIcon = null;
    $scope.initTabEventListeners = function() {
        console.log('int tab event listener');
        ...
        $document.on('click', '.tab', function(event) {
            ...
            // 根据tab ID判断tab类型
            if (tabId === 'nav-backgrounds') tabName = 'background';
            else if (tabId === 'nav-photos') tabName = 'photo';
            else if (tabId === 'nav-elements') tabName = 'element';
            else if (tabId === 'nav-typos') tabName = 'typography';
            else if (tabId === 'nav-cliparts') tabName = 'clipart';
            else if (tabId === 'nav-layers') tabName = 'layer';
            
            if (tabName) {
                if ($tab) {
                    // console.log('click tab: ', $tab);
                    var $icon = $tab.find('.icon-nbd')[0];
                    if ($icon) {
                        console.log('click icon: ', $icon);
                        $icon.style.color = 'yellow';      // 改变字体颜色
                        $icon.style.fill = 'yellow';       // 如果是SVG图标，改变填充色
                    }
                }
                if (tabName != $scope.currentTabName) {
                    console.log('DOM事件检测到tab点击:', tabName);

                    $scope.$apply(function() {
                        if ($scope.currentTabName === 'element') {
                            $scope.closeSubPage();
                        }
                        if ($scope.currentTabIcon) {
                            $scope.currentTabIcon.style.color = 'white';      // 改变字体颜色
                            $scope.currentTabIcon.style.fill = 'white';       // 如果是SVG图标，改变填充色
                        }
                        $scope.currentTabName = tabName;
                        $scope.currentTabIcon = $icon;
                    });
                }
        ...
        // 监听tab内容显示事件
        $document.on('show', '.tab', function(event) {
            var $tab = angular.element(event.currentTarget);
            var tabId = $tab.attr('id');
            console.log('Tab显示事件:', tabId);
        });
        
        // 监听tab内容隐藏事件
        $document.on('hide', '.tab', function(event) {
            var $tab = angular.element(event.currentTarget);
            var tabId = $tab.attr('id');
            console.log('Tab隐藏事件:', tabId);
        });
    };
    
    // 初始化事件监听器
    $timeout(function() {
        $scope.initTabEventListeners();
    });
    
    // 自定义事件监听
    $scope.$on('tabActivated', function(event, tabData) {
        console.log('收到tab激活事件:', tabData);
        $scope.onTabChanged(tabData.tabName);
    });
    
    // 触发自定义事件的函数
    $scope.triggerTabEvent = function(tabName, action) {
        $scope.$emit('tabActivated', {
            tabName: tabName,
            action: action,
    ...
    $scope.renderMasonryList = function(type, container, item, scrollContainer, init){  
        console.log('renderMasonryList type: ', type, ' container: ', container, ' item: ', item, ' scrollContainer: ', scrollContainer, ' init: ', init);
        if (type == 'background') {
            var containerView = document.querySelector(container);
            if(containerView) {
                containerView.style.padding = '5px';
            }
        ...
        if (type != 'background') {
            console.log('renderMasonryList begin-- type: ', type);
            console.log('renderMasonryList begin-- containerscrollTop: ', document.querySelector('.subpage-content-inner'));
            $scope.bindIconScrollEvent();
        }
        if (type == 'clipart') {
            console.log('renderMasonryList begin clipart');
            if ($scope.currentTabName === '') {
                const div = document.getElementById('nav-typos');
                if (div) {
                    console.log('nav div: ', div.innerHTML);
                    
                    //const elements = div.getElementsByClassName('icon-nbd');
                    var $fistIcon = div.querySelector('.icon-nbd-text-fields');
                    if ($fistIcon) {
                        console.log('click fistIcon: ', $fistIcon);
                        $fistIcon.style.color = 'yellow';      // 改变字体颜色
                        $fistIcon.style.fill = 'yellow';       // 如果是SVG图标，改变填充色
                        $scope.currentTabName = 'typography';
                        $scope.currentTabIcon = $fistIcon;
                        // $scope.$apply();
                    }
                }
            }
        ...
        imagesLoaded( jQuery(container), function() {
            console.log('renderMasonryList imagesLoaded init: ', init);
            if( !init ) {
                var masRes = true;
                try {
                    jQuery(container).masonry('destroy');
                } catch (error) {
                    console.log('masRes err name:', error.name, 'masRes err, container: ', jQuery(container), ' inp_container:', container); // 例如：ReferenceError
                    console.log('masRes err msg:', error.message); // 输出错误信息
                    masRes = false;
                }
                if (masRes) {
                    console.log('masRes ok, container: ', jQuery(container), ' inp_container:', container);
                }
            }
            if ($scope.resource[type].subPageTitle != '') {
                var containerView = document.querySelector(container);
                if(containerView) {
                    containerView.style.padding = '5px';
                }
                ...
                mansoryItems.forEach(function(item) {
                    var img = item.querySelector('img');
                    // console.log('mansoryItems img:', img.style);
                    // if (img) {
                    ...
                    //     // 当前显示尺寸
                    //     console.log('显示宽度:', img.offsetWidth);
                    //     console.log('显示高度:', img.offsetHeight);
                        
                    //     // 客户端尺寸（包含内边距和边框）
                    //     console.log('客户端宽度:', img.clientWidth);
                    //     console.log('客户端高度:', img.clientHeight);
                    // }
                    ...
                    item.style.height = offsetWidth + 'px';
                    item.style.padding = '5px';
                    item.style.overflow = 'hidden';
                    item.style.alignItems = 'center';
                    item.style.justifyContent = 'center';
                    var img = item.querySelector('img');
                    var rate1 = item.clientWidth / img.offsetWidth;
                    var rate2 = item.clientHeight / img.offsetHeight;
                    var scale = Math.min(rate1, rate2);
            ...
            console.log('renderMasonryList has init2 containerscrollTop');
            $grid.masonry('layout');
            
            console.log('renderMasonryList layoutComplete containerscrollTop: ', $scope.resource[type].subPageScrollTop);
            var subpage_content_inner = document.querySelector('.subpage-content-inner');
            if (subpage_content_inner) {
                subpage_content_inner.scrollTop = $scope.resource[type].subPageScrollTop;
            }
            var count = 0;
            ...
            // }
            console.log('renderMasonryList set onload: false count: ', count);
        });
    };
    // 绑定图标页面的滚动事件
    $scope.bindIconScrollEvent = function() {
        var scrollContainer = document.querySelector('.subpage-content-inner');
        if ($scope.resScrollContainer == null && scrollContainer) {
            console.log('绑定图标页面滚动事件');

            // 移除之前的事件监听器（如果存在）
            scrollContainer.removeEventListener('scroll', $scope.handleResScroll);
            
            // 添加新的滚动事件监听器
            scrollContainer.addEventListener('scroll', $scope.handleResScroll);
            // 存储容器引用
            $scope.resScrollContainer = scrollContainer;
    ...
    // 处理图标页面滚动事件
    $scope.handleResScroll = function(event) {
        var container = event.target;
        // console.log('handleResScroll, container: ', container);
        var scrollTop = container.scrollTop;
        var scrollHeight = container.scrollHeight;
        var clientHeight = container.clientHeight;
        var type = '';
        if (container) {
            var contentItem = container.querySelector('.content-item');
            if (contentItem) {
                type = contentItem.getAttribute('data-type')
            }
        }
        // console.log('图标页面滚动事件:', {
        //     scrollTop: scrollTop,
        ...
        if (scrollTop + clientHeight >= scrollHeight - 20) {
            console.log('滚动到底部，触发加载更多, container: ', container, ' scrollTop: ', scrollTop);
            $scope.resource[type].subPageScrollTop = scrollTop + clientHeight;
            $scope.scrollLoadMore('#tab-icon', type);
            // $scope.loadOSSFiles('icon', container);
            // container.scrollTop = scrollTop;
        } else {
            $scope.resource[type].subPageScrollTop = scrollTop;
        }
        
        // 触发自定义事件，供其他组件使用
        // $scope.$emit('iconPageScrolled', {
        //     scrollTop: scrollTop,
        //     scrollHeight: scrollHeight,
        //     clientHeight: clientHeight,
    ...
    $scope.scrollLoadMore = function(container, type){
        console.log('scrollLoadMore type: ', type);
        console.log('scrollLoadMore container: ', container, ' oss onload: ', $scope.resource[type].onload);
        if( $scope.resource[type].onload ) return;
        ...
        if( type == 'background' || $scope.resource[type].subPageTitle != ''){
            //$scope.resource[type].filter.currentPage < $scope.resource[type].filter.totalPage
            console.log('scrollLoadMore loadOSSFiles hasMore----', $scope.resource[type].hasMore);
            if( $scope.resource[type].hasMore === 'true'){
                $scope.resource[type].filter.currentPage += 1;
                $scope.loadOSSFiles(type, container);
            } else {
                jQuery(container + ' .loading-photo').hide();
                return;
            }
    ...
    $scope.generateTypoLink = function(typo){
        if (!typo) {
            console.log('generateTypoLink err typo: ', typo);
        ...
        console.log('generateTypoLink typo: ', typo, ' task: ', $scope.settings.task);
        var url;
        url = 'https://dujiayoupin.com/wp-content/plugins/web-to-print-online-designer/data/typography/local/' + typo.id + '/preview.png';

        // if( $scope.settings.task == 'typography' ){
            // if (typo.language == 'chinese') {
            //     url = 'https://dujiayoupin.com/wp-content/plugins/web-to-print-online-designer/data/typography/local/' + typo.id + '/preview.png';
            // } else {
            //     url = NBDESIGNCONFIG['plg_url'] + '/data/typography/img/' + typo.id + '.png';
            // }
        // }else{
        //     if (typo.language == 'chinese') {
        //         url = 'https://dujiayoupin.com/wp-content/plugins/web-to-print-online-designer/data/typography/local/' + typo.id + '/preview.png';
        //     } else {
        //         url = '//dpeuzbvf3y4lr.cloudfront.net/typography/' + typo.folder + '/preview.png';
        //     }
        // }
    ...
    $scope.saveData = function(type){
        ...
        console.log('NBDESIGNCONFIG.show_nbo_option: ', NBDESIGNCONFIG.show_nbo_option);
        ...
        if( angular.isUndefined( type ) && angular.isDefined( nbd_window.nbOption ) && angular.isDefined( nbd_window.nbOption.odOption ) 
            ...
            if(NBDESIGNCONFIG.show_nbo_option == "1" && NBDESIGNCONFIG.task == 'new' && NBDESIGNCONFIG.task2 == '' ){
                console.log('not in NBDESIGNCONFIG.show_nbo_option cart submit return');
                nbd_window.jQuery('.variations_form, form.cart').append('<input name="nbo-ignore-design" type="hidden" value="1" />');
                console.log('nbdesigner saveData cart submit ------');
        ...
        function _saveData(){
            ...
            switch(type){
                ...
                case 'saveforlater':
                default:
                    // var parentConfig = window.parent ? window.parent.NBDESIGNCONFIG : NBDESIGNCONFIG;
                    ['product_id', 'variation_id', 'task', 'task2', 'design_type', 'nbd_item_key', 'cart_item_key', 'order_id', 'enable_upload_without_design', 'auto_add_to_cart', 'ui_mode'].forEach(function(key){
                        console.log('saveData key: ', key, ' value: ', NBDESIGNCONFIG[key]);
                    ...
                    $timeout(function(){
                        // mzl note 这里触发nbd_save_cart_design action, -> nbd_save_cart_design -> add_to_cart
                        console.log(' ', NBDESIGNCONFIG.task);
                        console.log('saveData NBDESIGNCONFIG.ui_mode: ', NBDESIGNCONFIG.ui_mode);
                        console.log('saveData NBDESIGNCONFIG.show_nbo_option: ', NBDESIGNCONFIG.show_nbo_option);
                        console.log('saveData variation_id: ', NBDESIGNCONFIG.variation_id);
                        console.log('saveData dataObj: ', dataObj['variation_id']);
                        var action = ( !_.includes(excludeType, type) && NBDESIGNCONFIG.task == 'new' && NBDESIGNCONFIG.ui_mode == 2 ) ?  'nbd_save_customer_design' : 'nbd_save_customer_design';//nbd_save_cart_design
                        if(NBDESIGNCONFIG.show_nbo_option == "1" && NBDESIGNCONFIG.task == 'new'){
                        ...
                        if( NBDESIGNCONFIG.task == 'create' || ( NBDESIGNCONFIG.task == 'edit' && NBDESIGNCONFIG.design_type == 'template' )  ){
                            ...
                            console.log('saveData edit dataObj');
                        }
                        ...
                        NBDDataFactory.get(action, dataObj, function(data){
                            ...
                            if(data.flag == 'success'){
                                ...
                                if( type == 'saveforlater' ){
                                    console.log('NBDESIGNCONFIG saveforlater');
                                    ...
                                    console.log('NBDESIGNCONFIG type other auto_add_cart: ', NBDESIGNCONFIG['nbdesigner_auto_add_cart_in_detail_page']);
                                    if(NBDESIGNCONFIG.show_nbo_option == "1" && ( NBDESIGNCONFIG.task == 'new' || NBDESIGNCONFIG.task2 == 'update' ) ){
                                        if(NBDESIGNCONFIG.show_nbo_option == "1" && NBDESIGNCONFIG.task == 'new'){
                                            
                                        };
                                        console.log('NBDESIGNCONFIG show_nbo_option: cat submit');
                                        jQuery('.variations_form, form.cart').submit();
                                        return;
                                    }
                                    console.log('NBDESIGNCONFIG other url: ', NBDESIGNCONFIG['redirect_url']);
                                    if(NBDESIGNCONFIG['redirect_url'] != ""){
                                        if ( NBDESIGNCONFIG['task'] == 'edit' ) {
                                            window.location = NBDESIGNCONFIG['redirect_url'];
                                            console.log('NBDESIGNCONFIG edit redirect_url: ', NBDESIGNCONFIG['redirect_url']);
                                        }
                                        if (nbd_window && nbd_window.NBDESIGNERPRODUCT) {
                                            var val = NBDESIGNCONFIG['design'];
                                            // if (val) {
                                            //     nbd_window.NBDESIGNERPRODUCT.show_design_thumbnail([val], NBDESIGNCONFIG['task'], $scope.resource.config);//NBDESIGNCONFIG['design_images']
                                            // }
                                            // nbd_window.NBDESIGNERPRODUCT.get_sugget_design(NBDESIGNCONFIG['product_id'], NBDESIGNCONFIG['variation_id']);
                                        
                                            // 如果父窗口对象不存在，直接在当前窗口显示
                                            if (NBDESIGNCONFIG['design'] != "") {
                                                console.log('NBDESIGNCONFIG design length: ', NBDESIGNCONFIG['design_id']);
                                                var val = NBDESIGNCONFIG['design'];
                                                if (val) {
                                                    // 清除加载状态
                                                    jQuery('.nbd-loading-wrap').hide();
                                                    // 保存设计图片数据到 localStorage
                                                    try {
                                                        // localStorage.setItem('nbd_design_preview', JSON.stringify({
                                                        //     images: [val],
                                                        //     timestamp: new Date().getTime()
                                                        // }));
                                                        
                                                        console.log('Saved design preview, preparing to redirect');

                                                        // window.top.location.href = NBDESIGNCONFIG['redirect_url'];
                                                        ...
                                                        if (window.parent) {
                                                            // 隐藏设计器界面
                                                            window.parent.jQuery('#container-online-designer').removeClass('is-visible');
                                                            
                                                            console.log('隐藏设计器界面 done');
                                                            // 更新父窗口的预览
                                                            // if (window.parent.NBDESIGNERPRODUCT) {
                                                            //     window.parent.NBDESIGNERPRODUCT.reloadPreview(response.data);
                                                            // }
                                                        }
                                                        // 显示成功消息
                                                        console.log('设计已保存');
                                                        // showSuccessMessage('设计已保存');
                                    ...
                                    console.log('Auto add cart check:', {
                                        auto_add_cart: NBDESIGNCONFIG['nbdesigner_auto_add_cart_in_detail_page'],
                                        task: NBDESIGNCONFIG.task,
                                        ui_mode: NBDESIGNCONFIG.ui_mode,
                                        edit_option_mode: NBDESIGNCONFIG.edit_option_mode,
                                        product_id: NBDESIGNCONFIG.product_id
                                    });//&& NBDESIGNCONFIG.ui_mode == 1 && !( angular.isDefined( NBDESIGNCONFIG.edit_option_mode ) && NBDESIGNCONFIG.edit_option_mode == '1' 
                                    if( NBDESIGNCONFIG['nbdesigner_auto_add_cart_in_detail_page'] == "yes" &&  NBDESIGNCONFIG.task == 'new' ){
                                        ...
                                        nbd_window.NBDESIGNERPRODUCT.product_id = 
                                            NBDESIGNCONFIG.product_id;//NBDESIGNCONFIG['product_id'];
                                        nbd_window.NBDESIGNERPRODUCT.variation_id = NBDESIGNCONFIG.variation_id;//NBDESIGNCONFIG['variation_id'];
                ...
                if( obj.type == 'i-text' || obj.type == 'textbox' || obj.type == 'text' || obj.type == 'curvedText' ){
                    ...
                    if( fontWeight == 'bold' ){
                        ...
                        if( fontStyle == 'italic' ){
                            ...
                            font_url = (font.file && font.file.r && font.file.r != 1) ? font.file.r : (NBDESIGNCONFIG.default_font.file && NBDESIGNCONFIG.default_font.file.r ? NBDESIGNCONFIG.default_font.file.r : '');
                        }
                    }
    ...
    $scope.createPreviewWithClippath = function( index, callback ){
        console.log('scope.createPreviewWithClippath index: ', index);
        var stage = $scope.stages[index];
        if( angular.isUndefined( stage ) ) return;
        console.log('scope.createPreviewWithClippath stage: ', stage);
        ...
        if( !design ) return;
        console.log('scope.createPreviewWithClippath design: ', design);
        ...
        img.src = url;
        console.log('scope.saveDesign svg: ', svg, 'url: ', url);
    ...
    $scope.saveDesign = function( downloadType ){
        console.log('scope.saveDesign downloadType: ', downloadType);
        ...
        _.each($scope.stages, function(stage, index){
            ...
            // console.log('scope.saveDesign stage.design: ', stage.design);
    ...
    $scope.processProductSettings = function(){
        ...
        console.log('scope.settings.showRuler: ', $scope.settings.showRuler, ' appConfig.isModern', appConfig.isModern);
    ...
    // $scope.adjustMainPanelWidth = function() {
    //     var windowWidth = window.innerWidth;
    //     var sidebars = document.querySelectorAll('.nbd-sidebar');
    //     var mainPanels = document.querySelectorAll('.main');
        
    //     if(windowWidth < 1200) {
    //         sidebars.forEach(function(sidebar) {
    //             var isOpen = sidebar.classList.contains('is_open');
    //             mainPanels.forEach(function(mainPanel) {
    //                 if(isOpen) {
    //                     var sidebarWidth = sidebar.offsetWidth;
    //                     mainPanel.style.setProperty('width', `calc(100% - ${sidebarWidth}px)`, 'important');
    //                     mainPanel.style.transition = 'width 0.3s';
    //                 } else {
    ...
    //                 // 如果有canvas等，主动重绘
    //                 console.log('adjustMainPanelWidth windowWidth < 1200');
    //                 var canvas = mainPanel.querySelector('canvas');
    ...
    //     }
    //     $timeout(function() {
    //         $scope.stages && $scope.stages.forEach(function(stage) {
    //             console.log('adjustMainPanelWidth stage: ', stage);
    //             if(stage.canvas && stage.canvas.calcOffset) {
    //                 console.log('adjustMainPanelWidth stage.canvas: ', stage.canvas);
    //                 stage.canvas.calcOffset();
    //                 stage.canvas.requestRenderAll();
    //             }
    //         });
    //     }, 100);
    //     // 触发全局resize事件，通知其他监听者
    //     // window.dispatchEvent(new Event('resize'));
    // }
    // 添加窗口大小改变事件监听
    angular.element($window).bind('resize', function() {
        // 不建议重新计算，重新layout，因为用户上传的图片等资源也要进行重新计算大小，可能
        // 效果就不满足用户需求了
        // $scope.adjustMainPanelWidth();
        window.initModernLayout();
        const mainPanel = document.querySelector('.main');
        if(mainPanel) {
            mainPanel.style.transition = 'transform 0.3s ease';
    ...
    $scope.initRuler = function(){
        var viewPort = $scope.calcViewport();
        console.log('initRulerviewPort: ', viewPort);
        $timeout(function(){
            _.each($scope.settings.product_data.product, function(side, index){
                var stage = $scope.stages[index];
    ...
    $scope.calcRulerPaddingLeft = function(cwidth){
        ...
        additionalPadding = additionalPadding > 0 ? (additionalPadding + 0) : 0;
    ...
    $scope.onObjectAdded = function(id, options){
        ...
        if(type == 'i-text' || type == 'textbox' || type == 'text' || type == 'curvedText') {
            ...
            // 对于字体模板插入的文本对象，只做基本的初始化，不自动触发艺术效果
            if ($scope.contextAddLayers == 'template') {
                console.log('🎨 字体模板文本对象添加:', item.get('fontFamily'));
        ...
        // 强制触发艺术效果渲染
        setTimeout(function() {
            console.log('🎨 onObjectAdded 强制触发艺术效果渲染');
            // 获取当前文本对象的字体信息
            var currentFontFamily = item.get('fontFamily');
            console.log('🎨 onObjectAdded 当前字体:', currentFontFamily);
            
            // 获取字体信息，确定正确的字体名称
            var fontInfo = $scope.getFontInfo(currentFontFamily);
            var actualFontName = fontInfo ? fontInfo.name : currentFontFamily;
            var fontAlias = currentFontFamily;
            console.log('🎨 onObjectAdded 使用字体信息:', actualFontName, '别名:', fontAlias);
            
            // 先清理字体缓存，确保新字体能够正确应用
            if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
                fabric.util.clearFabricFontCache(actualFontName);
                fabric.util.clearFabricFontCache(fontAlias);
                console.log('🎨 onObjectAdded 清理字体缓存:', actualFontName, fontAlias);
            }
            
            // 直接设置字体，确保字体效果显示
            item.set('fontFamily', currentFontFamily);
            console.log('🎨 onObjectAdded 直接设置字体为:', currentFontFamily);
            
            // 使用setTextAttribute来正确触发艺术效果
            _canvas.setActiveObject(item);
            $scope.setTextAttribute('fontFamily', currentFontFamily);
            console.log('🎨 onObjectAdded 通过setTextAttribute设置字体:', item.get('fontFamily'));
            
            // 强制重新渲染以确保字体效果显示
            setTimeout(function() {
                // 再次直接设置字体，确保字体应用
                item.set('fontFamily', fontAlias);
                item.initDimensions();
                item.setCoords();
                _canvas.requestRenderAll();
                $scope.renderStage();
                console.log('🎨 onObjectAdded 强制重新渲染完成，字体已重新设置');
                
                // 再次强制渲染
                setTimeout(function() {
                    _canvas.requestRenderAll();
                    $scope.renderStage();
                    console.log('🎨 onObjectAdded 二次强制渲染完成');
                }, 50);
            }, 100);
            
            console.log('✅ onObjectAdded 艺术效果渲染完成');
        }, 100);
                    
                    console.log('✅ 字体模板文本对象初始化完成，艺术效果已自动渲染');
                }, 100);
            }
        }
        item.setCoords();
...
//            }
    ...
    $scope.onSelectionCreated = function(id, options){
        console.log('🎯 onSelectionCreated 被调用，目标对象:', options.target);
        console.log('🎯 目标对象类型:', options.target ? options.target.type : 'undefined');
        console.log('🎯 目标对象字体:', options.target ? options.target.get('fontFamily') : 'undefined');
        ...
        console.log('✅ onSelectionCreated 处理完成');
    }; 
    ...
    $scope.checkCharacter = function( object ){
        ...
        if( fontWeight == 'bold' ){
            ...
            if( fontStyle == 'italic' ){
                font_url = font.file && font.file.i ? font.file.i : '';
            } else {
                font_url = font.file && font.file.r ? font.file.r : '';
            }
        }
            ...
            if( object ){
                ...
                switch(object.type) {
                    ...
                    case 'curvedText':
                        ...
                        console.log('🔍 getCurrentLayerInfo 处理文本对象，字体:', fontFamily);
                        
                        var fontInfo = $scope.getFontInfo(fontFamily);
                        console.log('🔍 获取到的字体信息:', fontInfo);
    ...
    $scope.getFontInfo = function(alias){
        console.log('🔍 getFontInfo 被调用，字体别名:', alias);
        console.log('🔍 字体资源数据:', $scope.resource.font.data);
        
        var font = _.filter($scope.resource.font.data, { alias: alias, type: 'local' })[0];
        if (!font) {
            font = _.filter($scope.resource.font.data, { name: alias, type: 'local' })[0];
        }
        console.log('🔍 找到的字体:', font);
        
        var _font = angular.copy(font, _font);
        if(_font && font.file){    
            _font.file = {r: font.file.r || 0};
    ...
    // 检查CSS状态
    $scope.checkCSSStatus = function(fontName) {
    ...
    // 检查页面中的所有字体CSS
    $scope.checkAllFontCSS = function() {
        var fontCSS = [];
    ...
    // 强制重新注入字体CSS
    $scope.forceInjectCSS = function(fontName) {
    ...
    // 测试字体渲染
    $scope.testFontRendering = function(fontName) {
    ...
    $scope.checkFontResource = function(fontName) {
        var existingFont = $scope.resource.font.data.filter(function(font) {
            return font.alias === fontName;
        })[0];
    ...
    $scope.insertTemplateFont = function(font_name, callback){
        var insertTemplateFontStartTime = performance.now();
        var insertTemplateFontStartTimeISO = new Date().toISOString();
        console.log('🔤 [TIMING] insertTemplateFont 开始执行，字体:', font_name);
        console.log('🔤 [TIMING] 开始时间:', insertTemplateFontStartTimeISO);
        
        // if(!_.filter($scope.resource.font.data, ['alias', font_name]).length){
        //     var googleFontRequestStartTime = performance.now();
        //     console.log('🌐 [TIMING] 开始请求Google字体资源:', font_name);
        //     NBDDataFactory.get('nbd_get_resource', {type: 'google_font',font_name: font_name}, function(data){
        //         var googleFontRequestEndTime = performance.now();
        //         var googleFontRequestDuration = googleFontRequestEndTime - googleFontRequestStartTime;
        //         console.log('🌐 [TIMING] Google字体资源请求完成，耗时:', googleFontRequestDuration.toFixed(2), 'ms');
        //         data = JSON.parse(data);
        //         if( data.flag == 1 ){
        //             if(!_.filter($scope.resource.font.data, ['alias', font_name]).length){
        ...
        //             var font_id = fontName.replace(/\s/gi, '').toLowerCase();
        //             if( !jQuery('#' + font_id).length ){
        //                 // mzl mod jQuery('head').append('<link id="' + font_id + '" href="https://fonts.googleapis.com/css?family='+ fontName.replace(/\s/gi, '+') +':400,400i,700,700i" rel="stylesheet" type="text/css">');
        //             };
        //             if (typeof FontFaceObserver !== 'undefined') {
        //                 console.log('🔍 使用FontFaceObserver加载Google字体:', fontName);
        //                 var fontFaceObserverStartTime = performance.now();
        //                 console.log('🔍 [TIMING] FontFaceObserver开始加载字体:', fontName);
        //                 var font = new FontFaceObserver(fontName);
        //                 var previewText = $scope.settings.subsets[data.data.subset] ? $scope.settings.subsets[data.data.subset]['preview_text'] : 'Sample Text';
                        
        //                 font.load(previewText, 5000).then(function () {
        //                     var fontFaceObserverEndTime = performance.now();
        //                     var fontFaceObserverDuration = fontFaceObserverEndTime - fontFaceObserverStartTime;
        //                     console.log('✅ FontFaceObserver Google字体加载成功:', fontName);
        //                     console.log('🔍 [TIMING] FontFaceObserver加载耗时:', fontFaceObserverDuration.toFixed(2), 'ms');
        //                     if( angular.isDefined(callback) ) callback(fontName);
        //                 }, function (error) {
        //                     var fontFaceObserverEndTime = performance.now();
        //                     var fontFaceObserverDuration = fontFaceObserverEndTime - fontFaceObserverStartTime;
        //                     console.log('⚠️ FontFaceObserver Google字体加载失败，使用默认字体:', fontName, error);
        //                     console.log('🔍 [TIMING] FontFaceObserver失败耗时:', fontFaceObserverDuration.toFixed(2), 'ms');
        //                     if( angular.isDefined(callback) ) callback('Roboto');
        //                 });
        //     } else {
        //                 console.log('⚠️ FontFaceObserver不可用，直接使用Google字体:', fontName);
        //                 setTimeout(function() {
        //                     if( angular.isDefined(callback) ) callback(fontName);
        //                 }, 100);
        //             }
        ...
        //     });  
        // }else{
            var localFontProcessingStartTime = performance.now();
            console.log('🏠 [TIMING] 开始处理本地字体:', font_name);
            
            var _font = $scope.getFontInfo(font_name);
            console.log('🔍 获取字体信息:', font_name, _font);
            
            var getFontInfoEndTime = performance.now();
            var getFontInfoDuration = getFontInfoEndTime - localFontProcessingStartTime;
            console.log('🏠 [TIMING] 获取字体信息耗时:', getFontInfoDuration.toFixed(2), 'ms');
            
            if (!_font) {
                console.log('⚠️ 字体信息不存在:', font_name);
            ...
            if( !jQuery('#' + font_id).length ){
                ...
                //     // mzl mod jQuery('head').append('<link id="' + font_id + '" href="https://fonts.googleapis.com/css?family='+ fontName.replace(/\s/gi, '+') +':400,400i,700,700i" rel="stylesheet" type="text/css">');
                // }else{
                    if( _font.file && _font.file.r == '1' ){
                        var fontFileProcessingStartTime = performance.now();
                        console.log('📁 [TIMING] 开始处理字体文件:', font_name);
                        
                        var font_url = _font.url;
                        console.log('🔍 处理字体URL:', font_url, '类型:', typeof font_url);
                        
                        if( font_url && typeof font_url === 'string' && !(font_url.indexOf("http") > -1)) {
                            font_url = NBDESIGNCONFIG['font_url'] + font_url;
                            console.log('✅ 字体URL已处理:', font_url);
                        } else if (!font_url) {
                            console.log('⚠️ 字体URL为空, 使用url路径 font_name:', font_name);
                            font_url = 'https://mzl-debug-bucket.oss-cn-shanghai.aliyuncs.com/fonts/' + font_id + '.ttf';
                            // if (font_name === 'yuanti') {
                            //     console.log('⚠️ 字体URL为空，使用格式');
                            //     // font_url = '/wp-content/plugins/web-to-print-online-designer/assets/fonts/yuanti.woff2';
                            //     font_url = 'https://mzl-debug-bucket.oss-cn-shanghai.aliyuncs.com/fonts/yuanti.ttf';
                            // }
                        }
                        ...
                        css += "}";
                        css += "</style>";
                        var cssInjectionStartTime = performance.now();
                        jQuery("head").append(css);
                        var cssInjectionEndTime = performance.now();
                        var cssInjectionDuration = cssInjectionEndTime - cssInjectionStartTime;
                        console.log('✅ 字体CSS已注入:', fontName, font_url);
                        console.log('📊 [TIMING] CSS注入耗时:', cssInjectionDuration.toFixed(2), 'ms');
                        console.log('📊 CSS注入时间:', new Date().toISOString());
                        console.log('📊 CSS内容:', css);
                        
                        // 同时注入实际字体名称的CSS（如果字体信息中有实际名称）
                        var fontInfo = $scope.getFontInfo(fontName);
                        if (fontInfo && fontInfo.name && fontInfo.name !== fontName) {
                            var actualFontName = fontInfo.name;
                            var actualCss = '<style type="text/css">@font-face { font-family: "' + actualFontName + '"; src: url("' + font_url + '"); }</style>';
                            jQuery("head").append(actualCss);
                            console.log('✅ 实际字体CSS已注入:', actualFontName, font_url);
                            console.log('📊 实际字体CSS注入时间:', new Date().toISOString());
                            console.log('📊 实际字体CSS内容:', actualCss);
                        } else {
                            console.log('📊 字体别名和实际名称相同，无需额外CSS注入');
                        }
                        
                        // 验证字体是否真的可用 - 增加等待时间确保字体文件下载完成
                        // var fontVerificationStartTime = performance.now();
                        // console.log('🔍 [TIMING] 开始字体验证等待，等待时间:', new Date().toISOString());
                        // setTimeout(function() {
                        //     var fontVerificationTimeoutStartTime = performance.now();
                        //     console.log('🔍 开始字体验证，验证时间:', new Date().toISOString());
                        ...
                        //     console.log('🔍 字体验证 - 期望:', fontName, '实际:', actualFontFamily);
                        //     console.log('📊 字体验证完成时间:', new Date().toISOString());
                            
                        //     if (actualFontFamily.indexOf(fontName) > -1) {
                        //         console.log('✅ 字体验证成功:', fontName);
                        //         console.log('📊 字体状态: 已正确加载并可用');
                        //     } else {
                        //         console.log('⚠️ 字体验证失败，但继续使用:', fontName);
                        //         console.log('📊 字体状态: 可能未正确加载');
                                
                        //         // 如果字体验证失败，尝试使用实际字体名称
                        //         console.log('🔧 尝试使用实际字体名称进行验证');
                        //         var fontInfo = $scope.getFontInfo(fontName);
                        //         if (fontInfo && fontInfo.name && fontInfo.name !== fontName) {
                        //             var actualFontName = fontInfo.name;
                        //             var actualTestElement = document.createElement('span');
                        //             actualTestElement.style.fontFamily = actualFontName;
                        //             actualTestElement.style.fontSize = '16px';
                        //             actualTestElement.style.visibility = 'hidden';
                        //             actualTestElement.style.position = 'absolute';
                        //             actualTestElement.textContent = 'Test';
                        //             document.body.appendChild(actualTestElement);
                                    
                        //             var actualComputedStyle = window.getComputedStyle(actualTestElement);
                        //             var actualFontFamilyResult = actualComputedStyle.fontFamily;
                        //             document.body.removeChild(actualTestElement);
                                    
                        //             console.log('🔧 实际字体验证 - 期望:', actualFontName, '实际:', actualFontFamilyResult);
                        //             if (actualFontFamilyResult.indexOf(actualFontName) > -1) {
                        //                 console.log('✅ 实际字体验证成功:', actualFontName);
                        //                 console.log('📊 字体状态: 实际字体名称可用');
                        //             } else {
                        //                 console.log('⚠️ 实际字体验证也失败:', actualFontName);
                        //                 console.log('📊 字体状态: 字体可能仍在下载中');
                        //             }
                        //         } else {
                        //             console.log('📊 字体别名和实际名称相同，无需额外验证');
                        //         }
                        //     }
                            
                        //     var fontVerificationTimeoutEndTime = performance.now();
                        //     var fontVerificationTimeoutDuration = fontVerificationTimeoutEndTime - fontVerificationTimeoutStartTime;
                        //     var fontVerificationTotalEndTime = performance.now();
                        //     var fontVerificationTotalDuration = fontVerificationTotalEndTime - fontVerificationStartTime;
                        //     console.log('🔍 [TIMING] 字体验证timeout处理耗时:', fontVerificationTimeoutDuration.toFixed(2), 'ms');
                        //     console.log('🔍 [TIMING] 字体验证总耗时:', fontVerificationTotalDuration.toFixed(2), 'ms');
                        // }, 1000); // 增加等待时间到1秒，确保字体文件有足够时间下载
                        
                    }else if( _font.file ){
                        console.log('🔍 处理多文件字体:', _font.file);
                        var css = "<style type='text/css' id='" + font_id + "' >";
                        _.each(_font.file, function (file, index) {
                            if( file != 0 ){
                                var font_url = file;
                                if( file && typeof file === 'string' && !(file.indexOf("http") > -1)) {
                        ...
                        css += "</style>";
                        jQuery("head").append(css);
                        console.log('✅ 多文件字体CSS已注入:', fontName);
                    }else{
                        console.log('⚠️ 字体没有file属性，使用默认处理:', fontName);
                        // 对于没有file属性的字体，尝试使用默认路径
                        var defaultFontUrl = '/wp-content/plugins/web-to-print-online-designer/assets/fonts/' + font_id + '.ttf';
                        var css = "<style type='text/css' id='" + font_id + "' >";
                        css += "@font-face {font-family: '" + fontName + "';";
                        css += "src: url('" + defaultFontUrl + "') format('truetype');";
                    css += "font-weight: normal;font-style: normal;";
                    css += "}";
                    css += "</style>";
                    jQuery("head").append(css);
                        console.log('✅ 默认字体CSS已注入:', fontName, defaultFontUrl);
                    }
                // }
            };
            ...
            if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
                fabric.util.clearFabricFontCache();
                console.log('🧹 insertTemplateFont: 清理字体缓存');
            }
            
            // 检查FontFaceObserver是否可用
            if (typeof FontFaceObserver !== 'undefined') {
                console.log('🔍 使用FontFaceObserver加载字体:', fontName);
                console.log('📊 字体加载开始时间:', new Date().toISOString());
                console.log('📊 字体文件URL:', font_url);
                
                var font = new FontFaceObserver(fontName);
                var previewText = $scope.settings.subsets[_font.subset] ? $scope.settings.subsets[_font.subset]['preview_text'] : 'Sample Text';
                console.log('📊 预览文本:', previewText);
                
                var loadStartTime = performance.now();
                var retryCount = 0;
                var maxRetries = 5; // 适中的重试次数
                
                function attemptFontLoad() {
                    // 使用递增超时时间：第一次8秒，第二次12秒，第三次16秒
                    var timeout = 20000;//8000 + (retryCount * 4000);
                    font.load(previewText, timeout).then(function () {
                        var loadEndTime = performance.now();
                        var loadDuration = loadEndTime - loadStartTime;
                        console.log('✅ FontFaceObserver字体加载成功:', fontName, '重试次数:', retryCount);
                        console.log('📊 字体加载耗时:', loadDuration.toFixed(2), 'ms');
                        console.log('📊 字体加载完成时间:', new Date().toISOString());
                        console.log('📊 字体加载方式: 缓存命中或快速加载');
                        
                        // 清理字体缓存
                        if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
                            fabric.util.clearFabricFontCache(fontName);
                            console.log('🔧 清理字体缓存:', fontName);
                        }
                        ...
                        var loadEndTime = performance.now();
                        var loadDuration = loadEndTime - loadStartTime;
                        console.log('⚠️ FontFaceObserver字体加载失败:', fontName, '重试次数:', retryCount, '错误:', error);
                        console.log('📊 字体加载失败耗时:', loadDuration.toFixed(2), 'ms');
                        
                        // if (retryCount < maxRetries) {
                        //     console.log('🔄 重试字体加载:', fontName, '第', retryCount, '次重试，下次超时时间:', (8000 + (retryCount * 4000)) + 'ms');
                        //     // 使用指数退避延迟：1秒、2秒、4秒
                        ...
                        //     }, delay);
                        // } else {
                        //     console.log('📊 字体加载失败时间:', new Date().toISOString());
                        //     console.log('📊 字体加载方式: 多次重试后失败');
                            
                        //     // 即使FontFaceObserver失败，也要强制应用字体
                        //     console.log('🔧 FontFaceObserver失败，强制应用字体:', fontName);
                        ...
                        //         var fontInfo = $scope.getFontInfo(fontName);
                        //         if (fontInfo && fontInfo.name && fontInfo.name !== fontName) {
                        //             fabric.util.clearFabricFontCache(fontInfo.name);
                        //             console.log('🔧 清理字体缓存:', fontName, '和', fontInfo.name);
                        //         } else {
                        //             console.log('🔧 清理字体缓存:', fontName);
                        //         }
                        //     }
                            
                        //     // 即使FontFaceObserver失败，也继续执行回调，因为CSS已经注入
                        //     if( angular.isDefined(callback) ) callback(fontName);
                        // }
                    });
                }
                ...
                console.log('⚠️ FontFaceObserver不可用，直接使用字体:', fontName);
                console.log('📊 字体加载方式: 绕过FontFaceObserver');
                console.log('📊 直接使用开始时间:', new Date().toISOString());
                // 如果FontFaceObserver不可用，等待一小段时间后直接调用回调
                setTimeout(function() {
                    console.log('📊 直接使用完成时间:', new Date().toISOString());
                    if( angular.isDefined(callback) ) callback(fontName);
                }, 100);
            }
        // }
        
        // insertTemplateFont函数结束计时
        var insertTemplateFontEndTime = performance.now();
        var insertTemplateFontDuration = insertTemplateFontEndTime - insertTemplateFontStartTime;
        var insertTemplateFontEndTimeISO = new Date().toISOString();
        console.log('🔤 [TIMING] insertTemplateFont 函数执行完成，字体:', font_name);
        console.log('🔤 [TIMING] 函数结束时间:', insertTemplateFontEndTimeISO);
        console.log('🔤 [TIMING] 函数总执行时间:', insertTemplateFontDuration.toFixed(2), 'ms');
        console.log('🔤 [TIMING] ========================================');
    };
    $scope.onloadTemplate = false;
     ...
     // 全局字体缓存清理函数
     $scope.clearAllFontCache = function() {
         if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
             fabric.util.clearFabricFontCache();
             console.log('🧹 全局字体缓存已清理');
         }
     };
     
     $scope.insertTemplate = function(local, temp){
        console.log('[app-modern.min.js] insertTemplate', local, temp);
        ...
        function loadDesign(fonts, design, viewport, konfig){
            console.log('loadDesign ----', fonts, design, viewport, konfig);
            var stageIndex = 0;
            function loadStage(stageIndex){
                var _index = 'frame_' + stageIndex,
                stage = $scope.stages[stageIndex],
        ...
        if( local ){
            ...
            console.log('[app-modern.min.js] insertTemplate nbdesigner_get_product_info');
    ...
    $scope.boostInsertTemplate = function(local, temp){
        console.log('[app-modern.min.js] boostInsertTemplate', local, temp);
        $scope.currentLocalTempId = temp.id;
        if( angular.isUndefined( temp.doNotShowLoading ) ){
            $scope.toggleStageLoading( 6E4 );
            $scope.showDesignTab();
        ...
        if( local ){
            ...
            console.log('[app-modern.min.js] boostInsertTemplate nbdesigner_get_product_info');
            NBDDataFactory.get('nbdesigner_get_product_info', {product_id: NBDESIGNCONFIG['product_id'], variation_id: NBDESIGNCONFIG['variation_id'], template_id: temp.id}, function(data){
                data = JSON.parse(data);
                loadDesign(data.fonts, data.design, data.config.viewport, data.config);
                if( angular.isDefined( data.design_id ) ){
    ...
    $scope._insertPartTemplate = function(temp, partIndex){
        console.log('[app-modern.min.js] _insertPartTemplate', temp, partIndex);
        $scope.onloadTemplate = true;
        $scope.contextAddLayers = 'template';
        $scope.toggleStageLoading();
        jQuery('.insert-part-template-alert .close-popup').triggerHandler('click');
        function loadDesign(fonts, design, viewport, konfig){
            ...
            if( fonts.length ){
                // 只添加字体到资源数据，不重复加载字体
                // 字体加载将在insertTemplate函数中统一处理
                _.each(fonts, function(font, index){
                    if(!_.filter($scope.resource.font.data, ['alias', font.alias]).length){
                        if( angular.isDefined(font.file) && angular.isDefined(font.file.r) ){
                            $scope.resource.font.data.push(font);
                            console.log('📝 添加字体到资源数据:', font.alias);
                        }
                    };
                });
                
                // 直接调用loadStage，字体加载由insertTemplate处理
                if( $scope.settings.nbdesigner_boosting_load_template == 'yes' ){
                    boostLoadLayer();
                }else{
                    loadStage();
        ...
        console.log('[app-modern.min.js] _insertPartTemplate nbdesigner_get_product_info');
    ...
    $scope.addFontText = function(fontName){
        console.log('addFontText:', fontName);
                            
        $scope.addText('haha - ' + fontName, 'bodytext', {
            fontFamily: fontName,
            fontSize: 24,
    ...
    $scope.insertTypography = function(typo){
        // 函数开始计时
        var functionStartTime = performance.now();
        var functionStartTimeISO = new Date().toISOString();
        console.log('🚀 [TIMING] insertTypography 函数开始执行');
        console.log('🚀 [TIMING] 开始时间:', functionStartTimeISO);
        console.log('🚀 [TIMING] 开始时间戳:', functionStartTime.toFixed(2), 'ms');
        
         console.log('insertTypography 插入字体:', typo);
         
         // 检查是否可以添加更多图层
         var canAddLayerStartTime = performance.now();
         if( !$scope.canAddMoreLayer() ) {
             var canAddLayerEndTime = performance.now();
             var canAddLayerDuration = canAddLayerEndTime - canAddLayerStartTime;
             console.log('⚠️ [TIMING] canAddMoreLayer检查耗时:', canAddLayerDuration.toFixed(2), 'ms');
             return;
         }
         var canAddLayerEndTime = performance.now();
         var canAddLayerDuration = canAddLayerEndTime - canAddLayerStartTime;
         console.log('✅ [TIMING] canAddMoreLayer检查耗时:', canAddLayerDuration.toFixed(2), 'ms');
         
         // 在插入新字体模板前，清理所有字体缓存
         var clearCacheStartTime = performance.now();
         $scope.clearAllFontCache();
         var clearCacheEndTime = performance.now();
         var clearCacheDuration = clearCacheEndTime - clearCacheStartTime;
         console.log('🧹 [TIMING] 清理字体缓存耗时:', clearCacheDuration.toFixed(2), 'ms');
        ...
        try {
            // 触发字体插入事件
            var emitStartTime = performance.now();
            $scope.$emit('typographyInserted', typo);
            var emitEndTime = performance.now();
            var emitDuration = emitEndTime - emitStartTime;
            console.log('📡 [TIMING] 触发typographyInserted事件耗时:', emitDuration.toFixed(2), 'ms');
        var stage = $scope.stages[$scope.currentStage],
        scale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio,
        _canvas = stage['canvas'];
        ...
        $scope.toggleStageLoading();
        $scope.showDesignTab();
        var loadingEndTime = performance.now();
        var loadingDuration = loadingEndTime - loadingStartTime;
        console.log('🔄 [TIMING] 显示loading状态耗时:', loadingDuration.toFixed(2), 'ms');
        
        // 获取资源数据
        var getResourceStartTime = performance.now();
        var getResourceStartTimeISO = new Date().toISOString();
        console.log('📥 [TIMING] 开始获取字体资源数据');
        console.log('📥 [TIMING] 请求开始时间:', getResourceStartTimeISO);
        
        NBDDataFactory.get('nbd_get_resource', {type: 'get_typo', folder: typo.folder}, function(data){
            var getResourceEndTime = performance.now();
            var getResourceDuration = getResourceEndTime - getResourceStartTime;
            var getResourceEndTimeISO = new Date().toISOString();
            console.log('📥 [TIMING] 字体资源数据获取完成');
            console.log('📥 [TIMING] 请求完成时间:', getResourceEndTimeISO);
            console.log('📥 [TIMING] 网络请求耗时:', getResourceDuration.toFixed(2), 'ms');
            // 数据解析开始
            var parseDataStartTime = performance.now();
            ...
            var parseDataEndTime = performance.now();
            var parseDataDuration = parseDataEndTime - parseDataStartTime;
            console.log('📊 [TIMING] 数据解析耗时:', parseDataDuration.toFixed(2), 'ms');
            console.log('📊 [TIMING] 解析得到字体数量:', fonts.length);
            console.log('📊 [TIMING] 解析得到图层数量:', layers.length);
            
            // 优化的字体加载和文本创建流程
            function loadLayersWithFontEffects(){
                var loadLayersStartTime = performance.now();
                var loadLayersStartTimeISO = new Date().toISOString();
                console.log('🎨 [TIMING] 开始加载字体模板图层，确保艺术效果立即渲染');
                console.log('🎨 [TIMING] 图层加载开始时间:', loadLayersStartTimeISO);
                
                _.each(layers, function(layer, _index){
                    if( layer.fontFamily ){
                        layer.fontFamily = layer.fontFamily.replace(/\s/gi, '').toLowerCase();
                    }
                    console.log('loadLayers layer: ', layer, ' _index: ', _index);

                    if( _index == layers.length - 1 ){
                        var loadTemplateLayerStartTime = performance.now();
                        $scope.loadTemplateLayer(layer, function(){
                            var loadTemplateLayerEndTime = performance.now();
                            var loadTemplateLayerDuration = loadTemplateLayerEndTime - loadTemplateLayerStartTime;
                            console.log('📦 [TIMING] loadTemplateLayer(最后一个图层)耗时:', loadTemplateLayerDuration.toFixed(2), 'ms');
                            // 立即处理字体艺术效果，不等待renderTextAfterLoadFont
                            console.log('🎨 字体模板图层加载完成，立即触发艺术效果');
                            
                            // 清理字体缓存
                            var clearFontCacheStartTime = performance.now();
                            if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
                                fabric.util.clearFabricFontCache();
                                console.log('✅ 字体缓存已清理');
                            }
                            var clearFontCacheEndTime = performance.now();
                            var clearFontCacheDuration = clearFontCacheEndTime - clearFontCacheStartTime;
                            console.log('🧹 [TIMING] 清理字体缓存耗时:', clearFontCacheDuration.toFixed(2), 'ms');
                            
                            // 对每个文本对象进行基本初始化，不强制触发艺术效果
                            var processTextObjectsStartTime = performance.now();
                            console.log('🎨 [TIMING] 开始处理文本对象，数量:', $scope.resource.tempData.template.length);
                            _.each($scope.resource.tempData.template, function(textObj) {
                                if (textObj && (textObj.type === 'i-text' || textObj.type === 'textbox' || textObj.type === 'text' || textObj.type === 'curvedText')) {
                                    console.log('🎨 初始化文本对象:', textObj.get('fontFamily'));
                                    
                                     // 确保字体名称正确设置
                                     var fontFamily = textObj.get('fontFamily');
                                     console.log('🔧 当前字体名称xx:', fontFamily);
                                     
                                     // 立即触发艺术效果
                                    //  console.log('🎨 立即处理文本对象艺术效果:', fontFamily);
                                     
                                     // 获取字体信息，确定正确的字体名称
                                    //  var fontInfo = $scope.getFontInfo(fontFamily);
                                    //  var actualFontName = fontInfo ? fontInfo.name : fontFamily;
                                    //  var fontAlias = fontFamily;
                                    //  console.log('🎨 使用字体信息:', actualFontName, '别名:', fontAlias);
                                     
                                     // 清理字体缓存，确保新字体能够正确应用
                                     if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
                                         fabric.util.clearFabricFontCache(fontFamily);
                                        //  fabric.util.clearFabricFontCache(fontAlias);
                                         console.log('🎨 清理字体缓存:', fontFamily);
                                     }
                                     
                                     // 直接设置字体，确保字体效果显示
                                     textObj.set('fontFamily', fontFamily);
                                     console.log('🎨 直接设置字体为:', fontFamily);
                                     
                                     // 使用setTextAttribute来正确触发艺术效果
                                     _canvas.setActiveObject(textObj);
                                     $scope.setTextAttribute('fontFamily', fontFamily);
                                     console.log('🎨 通过setTextAttribute设置字体:', textObj.get('fontFamily'));
                                    ...
                                    _canvas.requestRenderAll();
                                     ...
                                     console.log('✅ 文本对象艺术效果已立即触发');
                                }
                            });
                            
                            var processTextObjectsEndTime = performance.now();
                            var processTextObjectsDuration = processTextObjectsEndTime - processTextObjectsStartTime;
                            console.log('🎨 [TIMING] 处理文本对象总耗时:', processTextObjectsDuration.toFixed(2), 'ms');
                            
                            // 创建选择集合并处理布局
                            var createSelectionStartTime = performance.now();
                            ...
                            var createSelectionEndTime = performance.now();
                            var createSelectionDuration = createSelectionEndTime - createSelectionStartTime;
                            console.log('📐 [TIMING] 创建选择集合并设置耗时:', createSelectionDuration.toFixed(2), 'ms');
                            
                            // 处理尺寸缩放
                            var scaleHandlingStartTime = performance.now();
                            ...
                            var scaleHandlingEndTime = performance.now();
                            var scaleHandlingDuration = scaleHandlingEndTime - scaleHandlingStartTime;
                            console.log('📏 [TIMING] 尺寸缩放处理耗时:', scaleHandlingDuration.toFixed(2), 'ms');
                            
                            // 居中显示
                            var centerDisplayStartTime = performance.now();
                                _canvas.viewportCenterObjectH(selection);
                                _canvas.viewportCenterObjectV(selection);
                                $scope.renderStage();
                            
                            var centerDisplayEndTime = performance.now();
                            var centerDisplayDuration = centerDisplayEndTime - centerDisplayStartTime;
                            console.log('🎯 [TIMING] 居中显示处理耗时:', centerDisplayDuration.toFixed(2), 'ms');
                            
                            // 最终处理
                            var finalProcessingStartTime = performance.now();
                                $timeout(function(){
                                var finalTimeoutStartTime = performance.now();
                                
                                // 最终确保所有文本对象的字体正确
                                 _.each($scope.resource.tempData.template, function(textObj) {
                                     if (textObj && (textObj.type === 'i-text' || textObj.type === 'textbox' || textObj.type === 'text' || textObj.type === 'curvedText')) {
                                         // 保持原始字体，不强制修改
                                         console.log('🔧 保持原始字体:', textObj.get('fontFamily'));
                                         textObj.initDimensions();
                                         textObj.setCoords();
                                    }
                                });
                                
                                var finalObjectProcessingStartTime = performance.now();
                                    $scope.deactiveAllLayer();
                                    _canvas.setActiveObject(selection);
                                    selection.addWithUpdate();
                                    _canvas.viewportCenterObjectH(selection);
                                ...
                                var finalObjectProcessingEndTime = performance.now();
                                var finalObjectProcessingDuration = finalObjectProcessingEndTime - finalObjectProcessingStartTime;
                                console.log('🔧 [TIMING] 最终对象处理耗时:', finalObjectProcessingDuration.toFixed(2), 'ms');
                                
                                // 最终渲染
                                var finalRenderStartTime = performance.now();
                                _canvas.requestRenderAll();
                                    $scope.renderStage();
                                
                                var finalRenderEndTime = performance.now();
                                var finalRenderDuration = finalRenderEndTime - finalRenderStartTime;
                                console.log('🎨 [TIMING] 最终渲染耗时:', finalRenderDuration.toFixed(2), 'ms');
                                
                                // 不在这里隐藏loading，等待所有渲染完成后再隐藏
                                
                                var finalTimeoutEndTime = performance.now();
                                var finalTimeoutDuration = finalTimeoutEndTime - finalTimeoutStartTime;
                                console.log('⏰ [TIMING] 最终timeout处理耗时:', finalTimeoutDuration.toFixed(2), 'ms');
                                
                                var finalProcessingEndTime = performance.now();
                                var finalProcessingDuration = finalProcessingEndTime - finalProcessingStartTime;
                                console.log('🏁 [TIMING] 最终处理总耗时:', finalProcessingDuration.toFixed(2), 'ms');
                                
        // 强制触发艺术效果渲染
        var forceRenderStartTime = performance.now();
        setTimeout(function() {
            var forceRenderTimeoutStartTime = performance.now();
            console.log('🎨 强制触发艺术效果渲染');
            var forceProcessTextObjectsStartTime = performance.now();
            console.log('🎨 [TIMING] 强制处理文本对象，数量:', $scope.resource.tempData.template.length);
            _.each($scope.resource.tempData.template, function(textObj) {
                if (textObj && (textObj.type === 'i-text' || textObj.type === 'textbox' || textObj.type === 'text' || textObj.type === 'curvedText')) {
                // 获取当前文本对象的字体信息
                var currentFontFamily = textObj.get('fontFamily');
                console.log('🎨 当前字体:', currentFontFamily);
                ...
                if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
                    fabric.util.clearFabricFontCache(actualFontName);
                    fabric.util.clearFabricFontCache(fontAlias);
                    console.log('🎨 清理字体缓存:', actualFontName, fontAlias);
                }
                
                // 直接设置字体，确保字体效果显示
                textObj.set('fontFamily', currentFontFamily);
                console.log('🎨 直接设置字体为:', currentFontFamily);
                ...
                console.log('🎨 通过setTextAttribute设置字体:', textObj.get('fontFamily'));
                    ...
                    setTimeout(function() {
                        // 再次直接设置字体，确保字体应用
                        textObj.set('fontFamily', fontAlias);
                        textObj.initDimensions();
                        textObj.setCoords();
                        _canvas.requestRenderAll();
                        $scope.renderStage();
                        console.log('🎨 强制重新渲染完成，字体已重新设置');
                        
                        // 再次强制渲染
                        setTimeout(function() {
                            _canvas.requestRenderAll();
                            $scope.renderStage();
                            console.log('🎨 二次强制渲染完成');
                            
                            // 所有渲染完成，隐藏loading
                            $scope.toggleStageLoading();
                            console.log('🎉 字体模板加载完全完成，隐藏loading');
                        }, 50);
                    }, 100);
                }
            });
            
            var forceProcessTextObjectsEndTime = performance.now();
            var forceProcessTextObjectsDuration = forceProcessTextObjectsEndTime - forceProcessTextObjectsStartTime;
            console.log('🎨 [TIMING] 强制处理文本对象总耗时:', forceProcessTextObjectsDuration.toFixed(2), 'ms');
            
            console.log('✅ 艺术效果渲染完成');
            
            var forceRenderTimeoutEndTime = performance.now();
            var forceRenderTimeoutDuration = forceRenderTimeoutEndTime - forceRenderTimeoutStartTime;
            console.log('⏰ [TIMING] 强制渲染timeout处理耗时:', forceRenderTimeoutDuration.toFixed(2), 'ms');
        }, 200);
                                
                                    $scope.setHistory($scope.currentStage, true);
                                
                                console.log('🎉 字体模板插入完成，艺术效果已自动渲染');
                                
                                var loadLayersEndTime = performance.now();
                                var loadLayersDuration = loadLayersEndTime - loadLayersStartTime;
                                var loadLayersEndTimeISO = new Date().toISOString();
                                console.log('🏁 [TIMING] loadLayersWithFontEffects函数总耗时:', loadLayersDuration.toFixed(2), 'ms');
                                console.log('🏁 [TIMING] 图层加载完成时间:', loadLayersEndTimeISO);
            ...
            if(fonts.length){
                var fontLoadingStartTime = performance.now();
                var fontLoadingStartTimeISO = new Date().toISOString();
                console.log('🎨 [TIMING] 开始加载字体，数量:', fonts.length);
                console.log('📊 [TIMING] 字体加载开始时间:', fontLoadingStartTimeISO);
                 var typographyLoadStartTime = performance.now();
                 
                 // 在开始加载新字体前，清理字体缓存
                 if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
                     fabric.util.clearFabricFontCache();
                     console.log('🧹 开始加载字体前，清理字体缓存');
                 }
                ...
                _.each(fonts, function(font, index){
                    console.log('insert Typographyfont: ', font);
                    // if(!_.filter($scope.resource.font.data, ['alias', font.alias]).length){
                    //     $scope.resource.font.data.push(font);
                    // };
                    ...
                    var fontPromise = new Promise(function(resolve) {
                        $scope.insertTemplateFont(font.alias, function(font_name){
                            console.log('insertTemplateFont callback: ', font_name);
                            if(!_.filter(stage.states.usedFonts, ['alias', font_name]).length){
                                stage.states.usedFonts.push($scope.getFontInfo(font_name));
                            };
                            resolve(font_name);
                        });
                    });
                ...
                var fontLoadingMidTime = performance.now();
                var fontLoadingMidTimeDuration = fontLoadingMidTime - fontLoadingStartTime;
                console.log('📊 [TIMING] 字体加载中间时间:', fontLoadingMidTimeDuration.toFixed(2), 'ms');

                // 等待所有字体加载完成后再创建文本对象
                Promise.all(fontLoadPromises).then(function(loadedFonts) {
                    var typographyLoadEndTime = performance.now();
                    var typographyLoadDuration = typographyLoadEndTime - typographyLoadStartTime;
                    var fontLoadingEndTime = performance.now();
                    var fontLoadingDuration = fontLoadingEndTime - fontLoadingStartTime;
                    var fontLoadingEndTimeISO = new Date().toISOString();
                    console.log('🎉 所有字体加载完成:', loadedFonts);
                    console.log('📊 [TIMING] 字体加载总耗时:', typographyLoadDuration.toFixed(2), 'ms');
                    console.log('📊 [TIMING] 字体加载完成时间:', fontLoadingEndTimeISO);
                    console.log('📊 [TIMING] 字体加载方式: Promise.all 成功');
                    console.log('📊 [TIMING] 字体加载阶段总耗时:', fontLoadingDuration.toFixed(2), 'ms');
                    
                    // 智能等待字体完全生效
                    var waitForFontsStartTime = performance.now();
                    waitForFontsToLoad(loadedFonts, function() {
                        var waitForFontsEndTime = performance.now();
                        var waitForFontsDuration = waitForFontsEndTime - waitForFontsStartTime;
                        console.log('⏰ 字体完全生效，开始创建文本对象');
                        console.log('📊 [TIMING] 字体等待生效耗时:', waitForFontsDuration.toFixed(2), 'ms');
                        console.log('📊 [TIMING] 字体生效时间:', new Date().toISOString());
                        loadLayersWithFontEffects();
                    });
                    ...
                    var fontLoadingDuration = fontLoadingEndTime - fontLoadingStartTime;
                    var fontLoadingEndTimeISO = new Date().toISOString();
                    console.log('⚠️ 字体加载过程中出现错误，继续执行:', error);
                    console.log('📊 [TIMING] 字体加载失败耗时:', typographyLoadDuration.toFixed(2), 'ms');
                    console.log('📊 [TIMING] 字体加载失败时间:', fontLoadingEndTimeISO);
                    console.log('📊 [TIMING] 字体加载方式: Promise.all 失败，使用回退机制');
                    console.log('📊 [TIMING] 字体加载阶段失败总耗时:', fontLoadingDuration.toFixed(2), 'ms');
                    
                    // 即使出错也等待一段时间
                    setTimeout(function() {
                        console.log('⏰ 错误情况下等待字体生效后开始创建文本对象');
                        console.log('📊 回退机制执行时间:', new Date().toISOString());
                        loadLayersWithFontEffects();
                    }, 2000);
                });
                
                // 智能字体加载检测函数
                function waitForFontsToLoad(fontNames, callback) {
                    var maxWaitTime = 20000; // 增加最大等待时间到20秒，确保第一次访问时有足够时间下载字体
                    var checkInterval = 300; // 增加检查间隔到300ms，减少频繁检查
                    var waitedTime = 0;
                    var checkCount = 0;
                    var lastLogTime = 0;
                    console.log('📊 开始智能字体检测，检测时间:', new Date().toISOString());
                    console.log('📊 检测字体列表:', fontNames);
                    console.log('📊 最大等待时间:', maxWaitTime, 'ms');
                    ...
                    function checkFonts() {
                        ...
                        _.each(fontNames, function(fontName) {
                            if (isFontReady(fontName)) {
                                readyFonts.push(fontName);
                            } else {
                                notReadyFonts.push(fontName);
                                allFontsReady = false;
                            }
                        });
                        
                        // 每5秒输出一次详细状态，避免日志过多
                        if (waitedTime - lastLogTime >= 5000) {
                            console.log('📊 字体检测第', checkCount, '次 - 就绪:', readyFonts, '未就绪:', notReadyFonts, '已等待:', Math.round(waitedTime/1000) + 's');
                            lastLogTime = waitedTime;
                        }
                        
                        if (allFontsReady || waitedTime >= maxWaitTime) {
                            console.log('✅ 字体检测完成，所有字体已就绪或达到最大等待时间');
                            console.log('📊 字体检测总耗时:', waitedTime, 'ms');
                            console.log('📊 字体检测完成时间:', new Date().toISOString());
                            console.log('📊 字体检测方式:', allFontsReady ? '所有字体就绪' : '达到最大等待时间');
                            console.log('📊 最终字体状态 - 就绪:', readyFonts, '未就绪:', notReadyFonts);
                            callback();
                        } else {
                    ...
                    // 开始检测
                    setTimeout(checkFonts, 800); // 先等待800ms再开始检测，给字体更多加载时间
                }
                
                // 检测字体是否真正可用
                function isFontReady(fontName) {
                    var testElement = document.createElement('span');
                    testElement.style.fontFamily = fontName + ', Arial, sans-serif';
                    testElement.style.fontSize = '16px';
                    testElement.style.visibility = 'hidden';
                    testElement.style.position = 'absolute';
                    testElement.textContent = 'Test';
                    ...
                    var isReady = actualFontFamily.indexOf(fontName) > -1;
                    ...
                    if (!isReady) {
                        ...
                        if (fontInfo && fontInfo.name && fontInfo.name !== fontName) {
                            var actualFontName = fontInfo.name;
                            var actualTestElement = document.createElement('span');
                            actualTestElement.style.fontFamily = actualFontName + ', Arial, sans-serif';
                            actualTestElement.style.fontSize = '16px';
                            actualTestElement.style.visibility = 'hidden';
                            actualTestElement.style.position = 'absolute';
                            actualTestElement.textContent = 'Test';
                            ...
                            isReady = actualFontFamilyResult.indexOf(actualFontName) > -1;
                            console.log('🔍 字体检测(实际名称):', actualFontName, '就绪:', isReady, '实际字体:', actualFontFamilyResult);
                        } else {
                            console.log('🔍 字体检测(别名):', fontName, '就绪:', isReady, '实际字体:', actualFontFamily);
                        }
                    } else {
                        console.log('🔍 字体检测(别名):', fontName, '就绪:', isReady, '实际字体:', actualFontFamily);
                    }
                    
                    console.log('📊 字体检测时间:', new Date().toISOString());
                    
                    return isReady;
                }
            }else{
                var noFontsStartTime = performance.now();
                var noFontsStartTimeISO = new Date().toISOString();
                console.log('📊 [TIMING] 无字体需要加载，直接处理图层');
                console.log('📊 [TIMING] 无字体处理开始时间:', noFontsStartTimeISO);
                loadLayersWithFontEffects();
                var noFontsEndTime = performance.now();
                var noFontsDuration = noFontsEndTime - noFontsStartTime;
                console.log('📊 [TIMING] 无字体处理耗时:', noFontsDuration.toFixed(2), 'ms');
            }
        });
        
        // 函数结束计时
        var functionEndTime = performance.now();
        var functionDuration = functionEndTime - functionStartTime;
        var functionEndTimeISO = new Date().toISOString();
        console.log('🏁 [TIMING] insertTypography 函数执行完成');
        console.log('🏁 [TIMING] 函数结束时间:', functionEndTimeISO);
        console.log('🏁 [TIMING] 函数总执行时间:', functionDuration.toFixed(2), 'ms');
        console.log('🏁 [TIMING] ========================================');
    ...
    $scope.insertCanvaTypo = function(typo){
        ...
        console.log('insertCanvaTypo --------: ', typo);
        $scope.stages[0].states.usedFonts = [];
        $scope.zoomStage(0);
    ...
    $scope.onSubpageScroll = function(event) {
        // 你可以在这里处理滚动逻辑，比如懒加载、显示返回顶部按钮等
        console.log('subpage scrollTop:', event.target.scrollTop);
    };
    $scope.addGeometricalObject = function( type ){
        ...
        var _ratio = $scope.element_ratio;
        var stage = $scope.stages[$scope.currentStage],
        _canvas = stage['canvas'],
        scale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio;
        ...
        //if ( object.width < max_width ) new_width = object.width;
        var width_ratio = new_width / object.width,
        new_height = object.height * width_ratio;
        if ( new_height > max_height ) {
            new_height = max_height;
            var height_ratio = new_height / object.height;
            new_width = object.width * height_ratio;
            console.log(' big new_height: ', new_width, ' object.width: ', object.width);
        };

        // op.scaleX = new_width / op.width;
        // op.scaleY = new_height / op.height;
        console.log(' scale width: ', new_width / object.width);
        if (type === 'line') {
            object.set({
                scaleX: new_width / object.width,
                scaleY: 1
            });
        } else {
            object.set({
                scaleX: new_width / object.width,
                scaleY: new_height / object.height
            });
        }
        console.log('addGeometricalObject object.scaleX: ', object.scaleX, ' object.scaleY: ', object.scaleY);
        _canvas.add(object);
    };
    $scope.tempLayer = {};
                ...
                if( type == 'image' || type == 'custom-image' ){
                    ...
                    klass.fromObject(object, function(object){
                        if( ['i-text', 'text', 'textbox', 'curvedText'].indexOf( object.type ) > -1  ){
                            ...
                            var isSystemFont = systemFonts.indexOf(fontName) !== -1;
                            
                            if (isSystemFont) {
                                // 系统字体直接使用，不需要FontFaceObserver
                                console.log('使用系统字体:', fontName);
                                fabric.util.clearFabricFontCache(fontName);
                                addLayer(object);
                            } else {
                                // 网络字体使用FontFaceObserver
                                var font = new FontFaceObserver(fontName, {weight: object.fontWeight, style: object.fontStyle});
                                font.load(content).then(function () {
                                    fabric.util.clearFabricFontCache(fontName);
                                    addLayer(object);
                                }, function () {
                                    console.log('⚠️ 网络字体加载失败，继续使用:', fontName);
                                    addLayer(object);
                                });
                            }
                        }else{
...
/*         var _canvas = this.stages[stage_id]['canvas'];
    ...
    $scope.getBackgroundImgList = function(){
        $scope.resource.backgroundImgList = angular.isDefined( $scope.settings.backgroundList ) ? $scope.settings.backgroundList : [];
        $scope.backgroundImgLitmit = 24;
    };
    $scope.loadMoreBackgroundImgList = function(){
        if( $scope.backgroundImgLitmit < $scope.resource.backgroundImgList.length ) $scope.backgroundImgLitmit += 24;
    };
    ...
    $scope.addText = function(content, type, additionalObj){
        ...
        if( additionalObj ){
            ...
            // 如果指定了fontFamily，使用指定的字体
            if (additionalObj.fontFamily) {
                fontName = additionalObj.fontFamily;
                textObj.fontFamily = fontName;
            }
        };
        function addText(){
        ...
        if (isSystemFont) {
            ...
            font.load(content).then(function () {
                ...
                console.log('⚠️ 网络字体加载失败，使用系统字体:', fontName);
                // 字体加载失败时，回退到Arial
    ...
    // 显示提示框
    $scope.showBackgroundTip = function() {
        // console.log('显示提示框');
        var tip = jQuery('#background-tip-text');
        var icon = jQuery('.background-tip');
        var iconOffset = icon.offset();
        
        tip.css({
            top: iconOffset.top + icon.height() + 5,
            left: iconOffset.left
        }).addClass('show');
    };
    
    // 隐藏提示框
    $scope.hideBackgroundTip = function() {
        // console.log('隐藏提示框');
        jQuery('#background-tip-text').removeClass('show');
    };
    
    // 点击外部关闭提示框
    $document.on('click', function(event) {
        var $target = jQuery(event.target);
        if (!$target.closest('.background-tip, #background-tip-text').length) {
            $scope.hideBackgroundTip();
        }
    });
    // $scope.showBackgroundTip = function(){
    //     console.log('showBackgroundTip ---');
    //     document.querySelector('#background-tip-text').style.display = 'block';
    // }
    // 设置文本属性
    $scope.setTextAttribute = function(type, value, extra_option){
        console.log('🔧 setTextAttribute 被调用:', type, value);
        var _stage = $scope.stages[$scope.currentStage],
            _states = _stage.states,
            _canvas = _stage['canvas'];
        if( !appConfig.ready ) {
            console.log('⚠️ setTextAttribute: appConfig.ready 为 false，延迟执行');
            // 延迟执行，等待appConfig.ready变为true
            setTimeout(function() {
                $scope.setTextAttribute(type, value, extra_option);
            }, 100);
            return;
        }
        var item = _canvas.getActiveObject();
        var items = _canvas.getActiveObjects();
        console.log('🔧 setTextAttribute: item =', item, 'items =', items);
        if( !item || !items ) {
            console.log('⚠️ setTextAttribute: 没有活动对象，直接返回');
            return;
        }
        $scope.beforeObjectModify(item);
        var ob = {};ob[type] = value;
        ...
        if(type == 'rtl'){
         ...
         if( type.indexOf("font") > -1 ){
             console.log('🔧 setTextAttribute: 开始字体加载流程');
             
             // 在设置字体前清理缓存
             if (typeof fabric !== 'undefined' && fabric.util && fabric.util.clearFabricFontCache) {
                 fabric.util.clearFabricFontCache();
                 console.log('🧹 setTextAttribute: 清理字体缓存');
             }
            ...
            font.load(item.get('text')).then(function () {
                console.log('🔧 setTextAttribute: FontFaceObserver 加载成功');
                ...
                $timeout(function(){
                    ...
                    item.setCoords();
                    $scope.renderStage(); 
                    console.log('🔧 setTextAttribute: 字体加载完成，重新渲染');
                    
                    // 渲染完成后再调用afterObjectModify，避免隐藏loading
                    $timeout(function(){
                        $scope.afterObjectModify();
                        console.log('🔧 setTextAttribute: 字体加载和渲染完全完成');
                    }, 50);
                });
            }, function () {
                console.log('🔧 setTextAttribute: FontFaceObserver 加载失败，强制应用艺术效果');
                // 即使FontFaceObserver失败，也要强制应用艺术效果
                fabric.util.clearFabricFontCache(_states.text.fontFamily);
                
                // 直接设置字体，不依赖FontFaceObserver
                item.set('fontFamily', _states.text.fontFamily);
                console.log('🔧 setTextAttribute: 直接设置字体为:', _states.text.fontFamily);
                ...
                $timeout(function(){
                    ...
                    item.setCoords();
                    $scope.renderStage();
                    console.log('🔧 setTextAttribute: 强制艺术效果渲染完成');
                    
                    // 渲染完成后再调用afterObjectModify，避免隐藏loading
                    $timeout(function(){
                        $scope.afterObjectModify();
                        console.log('🔧 setTextAttribute: 强制艺术效果应用完全完成');
                    }, 50);
                });
            });
            if( $scope.settings.nbdesigner_enable_text_check_lang == 'yes' ){
    ...
    // 点击显示/隐藏提示
    $scope.toggleHelpTooltip = function(event) {
    ...
    $scope.setBackgroundUrl = function(url) {
        console.log('setBackgroundUrl data length: ', $scope.resource.upload.data.length);
        $scope.toggleStageLoading();
        $scope.setBackgroundInner(url);
        $scope.toggleStageLoading();
        console.log('setBackgroundUrl done data length: ', $scope.resource.upload.data.length);
    }

    // 正确加载OSS图片的fabric.js方法
    async function loadOssImageToCanvas(imageUrl, callback) {
        ...
        // 添加时间戳避免缓存
        const finalUrl = `${imageUrl}?ts=${Date.now()}`;
        ...
        img.onload = () => {
            ...
            // canvas.renderAll();
            // resolve(fabricImg);
            console.log('loadOssImageToCanvas done fabricImg', fabricImg);
            callback(fabricImg);
        };
        ...
        // img.onload = () => {
        //     // 此时可正确获取原始宽高
        //     console.log("真实宽高:", img.width, img.height);
            
        //     // 设置缩放并添加到画布
        //     // img.scaleToWidth(300);
        //     // canvas.add(img);
        //     console.log('loadOssImageToCanvas done img', img);
        //     callback(img);
        // };
        // 特殊处理：如果图片有缓存，可能不会触发onload
        // if (img.complete) {

        // }
        });
    }
    $scope.setBackgroundInner = function(url) {
        console.log('setBackgroundInner ', url);
        var stage = $scope.stages[$scope.currentStage];
        if (!stage) return;
        var canvas = stage.canvas;
        if (!canvas) return;
        var stageBg = document.querySelector('.stage-background');

        // 获取其子元素 img
        var img = stageBg.querySelector('img');
        ...
        loadOssImageToCanvas(url, function(img) {
            ...
            img.set({
                originX: 'center',
                originY: 'center',
                left: canvas.width / 2,  // 画布中心x坐标
                top: canvas.height / 2,   // 画布中心y坐标
                scaleX: scale,
                scaleY: scale
            });
    
            console.log('Applied scale44:', scale);
            ...
            canvas.setBackgroundImage(img, function() {
                ...
                stage.states.background = {
                    type: 'image',
                    url: url,
                    scale: scale
                };
                
                // 如果在 Angular 作用域外调用，需要手动触发更新
                if (!$scope.$$phase) {
                    $scope.$apply();
                }
            });
    ...
    $scope.clearBackgroundFiles = function() {
        $scope._localStorage.delete('nbdbackground');
        $scope.resource.background.data = [];
        // todo
        // document.querySelector('.nbdesigner-default-image').style.display = 'block';
    }
    $scope.saveCustomerFile = function(file, type, func) {
        console.log('saveCustomerFile file', file, ' type: ', type);
        ...
        NBDDataFactory.get('nbdesigner_customer_upload', {file: file}, function(data){
            var data = JSON.parse(data);
            if( data.flag == 1 ){
                if( angular.isDefined(data.ilr) ) $scope.resource.background.ilr = true;
                if( $scope.resource.background.ilr && NBDESIGNCONFIG['nbdesigner_enable_low_resolution_image'] == 'no' ){
                    $scope.toggleStageLoading();
                    alert(data.mes);
                    return;
                };
                // todo
                data.name = file.name;
                $scope.storeBackgroundFile(data, data.name, type);

                console.log('uploadFile input data url', data.src);
                var url = data.src;
                // if ($scope.resource.background.data.length > 0) {
                //     document.querySelector('.nbdesigner-default-image').style.display = 'none';
                // } else {
                //     document.querySelector('.nbdesigner-default-image').style.display = 'block';
                // }
                if (type == 'nbdbackground') {
                ...
                $scope.toggleStageLoading();
                console.log('saveCustomerFile done data length: ', $scope.resource.background.data.length);
            }
        });
    };
    ...
    $scope.addImage = function(data, showLoading, hideLoading, additionalTitle, additionalValue, maskId ){
        console.log('app addImage data: ', data);
        var stage = $scope.stages[$scope.currentStage],
            _canvas = stage['canvas'],
            scale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio,
        ...
        fabric.Image.fromURL(url, function(img) {
            if( angular.isDefined( maskId ) || $scope.stages[$scope.currentStage].states.elementUpload ){
                var canvasObj;
                if( angular.isDefined( maskId ) ){
                    canvasObj = $scope.getMaskedLayerByMaskId( maskId );
                } else {
                    canvasObj = _canvas.getActiveObject();
                }
                var element = canvasObj.getElement();
                $scope.beforeObjectModify(canvasObj);
                element.setAttribute("src", url);
                var scaleX = canvasObj.width * canvasObj.scaleX / img.width,
                scaleY = canvasObj.width * canvasObj.scaleX / img.width;
                console.log('addImage canvasObj.width: ', canvasObj.width, ' canvasObj.scaleX: ', canvasObj.scaleX, ' img.width: ', img.width);
                console.log('addImage scaleX: ', scaleX, ' scaleY: ', scaleY);
                if( angular.isDefined( maskId ) ) {
                    ...
                    console.log('addImage maskId defined canvasObj.width: ', canvasObj.width, ' canvasObj.scaleX: ', canvasObj.scaleX, ' img.width: ', img.width);
                    console.log('addImage maskId defined scaleX: ', scaleX, ' scaleY: ', scaleY);
                }
                canvasObj.set({
                    dirty: true,
                    width: img.width,
                ...
                if( typeof data == 'object' && angular.isDefined( data.origin_url ) ){
                    if( angular.isDefined( maskId ) ) {
                        ...
                        var scaleX = canvasObj.width * canvasObj.scaleX / data.width,
                        scaleY = canvasObj.width * canvasObj.scaleX / data.width;
                    }
                    canvasObj.set({
                ...
                }else if( !!canvasObj.origin_url ){
                    delete canvasObj.origin_url; 
                }

                canvasObj.setCoords();
                if( angular.isDefined( maskId ) ) $scope.adjustMaskedLayers(canvasObj);
                $scope.renderStage();
                if( angular.isDefined( maskId ) ) {
                    $scope.adjustMaskedLayers(canvasObj);
                    if( $scope.checkActiveFilter && canvasObj.filters.length ){
                        canvasObj._originalElement = img._element;
                        canvasObj.applyFilters(false, function(){
                ...
                max_height = _canvas.height / scale * _ratio,
                new_width = max_width;
                console.log('addImage2 _ratio: ', _ratio, ' _canvas.width: ', _canvas.width);
                console.log('addImage2 img.width: ', img.width, ' img.height: ', img.height);
                console.log('addImage2 max_width: ', max_width, ' max_height: ', max_height);
                console.log('addImage2 new_width: ', new_width);
                if ( img.width < max_width ) new_width = img.width;
                console.log('addImage3 new_width: ', new_width);
                var width_ratio = new_width / img.width,
                new_height = img.height * width_ratio;
                if ( new_height > max_height ) {
                    new_height = max_height;
                    var height_ratio = new_height / img.height;
                    new_width = img.width * height_ratio;
                    console.log('addImage4 new_width: ', new_width);
                };
                img.set({
                    fill: '#ff0000',
                ...
                console.log('addImage5 scaleX: ', new_width / img.width, ' scaleY: ', new_height / img.height);

                if( typeof data == 'object' && angular.isDefined( data.origin_url ) ){
                    console.log('addImage6 origin_width: ', data.width, ' new_width: ', new_width);
                    img.set({
                        origin_url: data.origin_url,
                        origin_width: data.width,
                        origin_height: data.height,
                    ...
                    console.log('addImage7 scaleX: ', new_width / data.width, ' scaleY: ', new_height / data.height);
                }
                ...
                if( additionalTitle ) img[additionalTitle] = additionalValue;
                _canvas.add(img);
            }
            if( hideLoading ) {
                $timeout(function(){
    ...
    $scope.addSvgFromString = function(svg, showLoading){
        ...
        console.log('app-modern.min.js addSvgFromString svg ', svg);
    ...
    $scope.addArt = function(art, showLoading, hideLoading){
        if( showLoading ) $scope.toggleStageLoading();
        console.log('app-modern.min.js addArt art', art);
        if(art.url.match(/\.(jpeg|jpg|gif|png)$/) != null){
            ...
            fabric.loadSVGFromURL(art.url, function(ob, op) {
                if(ob){
                    ...
                    // console.log('addArt loadSVGFromURL op.scaleX: ', op.scaleX, ' op.scaleY: ', op.scaleY);
                    console.log('addArt loadSVGFromURL ob.width: ', ob.width, ' ob.height: ', ob.height);
                    console.log('addArt loadSVGFromURL op.width: ', op.width, ' op.height: ', op.height);
                    
                    // 关键：将 objects 组合成一个 group
                    var svgGroup = fabric.util.groupSVGElements(ob, op);
                    ...
                    // 添加到画布
                    _canvas.add(svgGroup);

                    // 其他后续操作
                    //$scope._addSvg && $scope._addSvg(ob, op, art, hideLoading);
    ...
    $scope.addElement = function(data, showLoading, hideLoading, additionalTitle, additionalValue, maskId ){
        var stage = $scope.stages[$scope.currentStage],
            _canvas = stage['canvas'],
            scale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio,
            url = typeof data == 'object' ? ( angular.isDefined( data.src ) ? data.src : data.url ) : data;
        ...
        console.log('app-modern.min.js addElement fromURL url: ', url, ' maskId: ', maskId, ' hideLoading: ', hideLoading);
        fabric.Image.fromURL(url, function(op) {
            if( angular.isDefined( maskId ) || $scope.stages[$scope.currentStage].states.elementUpload ){
                var object;
                if( angular.isDefined( maskId ) ){
    ...
    $scope.addElementImage = function(element, showLoading, hideLoading){
        if( showLoading ) $scope.toggleStageLoading();
        console.log('app-modern.min.js addElementImage element url ', element.url);
        if(element.url.match(/\.(jpeg|jpg|gif|png)$/) != null){
            $scope.addImage(element.url, false, hideLoading);
        }else{
            fabric.loadSVGFromURL(element.url, function(ob, op) {
                if(ob){
                    $scope._addSvg(ob, op, element, hideLoading);
                }else{
                    alert('Try again!');
                    $scope.toggleStageLoading();
                }
    ...
    $scope.create3DTextureEffect = function(productImg, previewImg) {
        console.log('Creating 3D texture effect');
        ...
        // 计算预览图的位置和大小（居中显示）
        const previewSize = Math.min(canvas.width, canvas.height) * 0.8; // 预览图大小为画布的80%
        const previewX = (canvas.width - previewSize) / 2;
        const previewY = (canvas.height - previewSize) / 2;
        console.log('Preview position:', previewX, previewY);
        ...
        if (previewImg.complete) {
            ...
            // 直接绘制预览图
            ctx.drawImage(previewImg, previewX, previewY, previewSize, previewSize);
            ...
            ctx.shadowOffsetX = 5;
            ctx.shadowOffsetY = 5;
            ctx.drawImage(previewImg, previewX + 5, previewY + 5, previewSize, previewSize);
            ctx.restore();
        } else {
            console.log('Preview image is not loaded yet');
            // 添加加载事件监听器
            previewImg.onload = function() {
                console.log('Preview image loaded in onload');
                ctx.drawImage(previewImg, previewX, previewY, previewSize, previewSize);
    ...
    $scope.show2DPreview = function(){
        // 创建预览容器
        var preview2dWrap = document.createElement('div');
        preview2dWrap.className = 'nbd-2d-preview-wrap';
        preview2dWrap.innerHTML = `
            <div class="nbd-2d-preview-container">
                <div class="nbd-2d-preview-header">
                    <span>2D预览</span>
                    <span class="nbd-2d-preview-close" onclick="jQuery('.nbd-2d-preview-wrap').remove()">×</span>
                </div>
                <div id="nbd-2d-preview"></div>
            </div>
        `;
        ...
        document.body.appendChild(preview2dWrap);
    
        // 获取当前设计的数据
        // var data = {
        //     design: currentCanvas.toDataURL({
        //         format: 'png',
        //         quality: 1,
        //         multiplier: 1
        //     })
        ...
        // 等待DOM更新
        setTimeout(function() {
            var currentStage = $scope.stages[$scope.currentStage];
            if (!currentStage || !currentStage.canvas) {
                console.warn('无法获取画布数据');
                return;
            }

            // 创建预览canvas
            var previewCanvas = document.createElement('canvas');
            var previewContainer = document.getElementById('nbd-2d-preview');
            previewContainer.appendChild(previewCanvas);

            // 设置预览canvas尺寸
            var containerWidth = previewContainer.clientWidth - 40;
            var containerHeight = previewContainer.clientHeight - 40;
            var originalWidth = currentStage.canvas.width;
            var originalHeight = currentStage.canvas.height;
            ...
            previewCanvas.width = originalWidth * scale;
            previewCanvas.height = originalHeight * scale;
            ...
            // 获取画布数据并绘制
            var dataUrl = currentStage.canvas.toDataURL({
                format: 'png',
                quality: 1
            });
            
            console.log('show2DPreview dataUrl', dataUrl);

            console.log('show2DPreview productInfo id: ', NBDESIGNCONFIG.product_id);
            console.log('show2DPreview ajax_url: ', NBDESIGNCONFIG['ajax_url']);
            console.log('show2DPreview stage.design: ', $scope.stages[0].design);
            NBDDataFactory.get('nbdesigner_get_product_info', {product_id: NBDESIGNCONFIG['product_id'], variation_id: NBDESIGNCONFIG['variation_id']}, function(data){
                data = JSON.parse(data);
                console.log('nbdesigner_get_product_info show2DPreview data', data);
                // todo 遍历所有的stages中的design，获取设计图
                console.log('nbdesigner_get_product_info folder', $scope.stages[0].design);

                // 创建预览容器
                var preview2dWrap = document.createElement('div');
                preview2dWrap.className = 'nbd-2d-preview-wrap';
                // 修改 HTML 结构，添加一个容器来包裹缩略图 Swiper
                preview2dWrap.innerHTML = `
                <div class="nbd-2d-preview-container">
                    <div class="nbd-2d-preview-header">
                        <span>2D预览</span>
                                ...
                                ${data.product.map((item, index) => `
                                    <div class="swiper-slide">
                                        <div class="preview-image-container">
                                            <img src="${item.img_overlay}" class="base-image" alt="base"/>
                                            <canvas class="design-overlay" id="preview-canvas-${index}"></canvas>
                                        </div>
                                    </div>
                                `).join('')}
                            </div>
                                    ...
                                    ${data.product.map((item, index) => `
                                        <div class="swiper-slide">
                                            <div class="thumb-preview-container">
                                                <img src="${item.img_overlay}" class="thumb-base-image" alt="thumb"/>
                                                <canvas class="thumb-design-overlay" id="thumb-canvas-${index}"></canvas>
                                            </div>
                                        </div>
                                    `).join('')}
                                </div>
                ...
                style.textContent = `
                    ...
                    .preview-image-container img.base-image {
                        max-width: 100%;
                        max-height: 100%;
                        object-fit: contain;
                    }

                    .preview-image-container canvas.design-overlay {
                        position: absolute;
                        top: 0;
                        left: 0;
                        width: 100%;
                    ...
                    .thumb-preview-container {
                        ...
                        padding: 2px; /* 添加内边距，为选中边框留出空间 */
                    }

                    .thumb-preview-container img.thumb-base-image {
                        width: 100%;
                        height: 100%;
                        object-fit: contain;
                    }

                    .thumb-preview-container canvas.thumb-design-overlay {
                        position: absolute;
                        top: 50%;
                        left: 50%;
                        transform: translate(-50%, -50%);
                        width: calc(100% - 4px); /* 减去padding的宽度 */
                        height: calc(100% - 4px); /* 减去padding的宽度 */
                    }
                    ...
                    .thumbSwiper .swiper-slide {
                        ...
                        box-sizing: border-box; /* 添加这行确保边框计入总宽度 */
                    }
                ...
                swiperContainer.style.touchAction = 'pan-y pinch-zoom'; // 只允许垂直滑动和缩放
                // 初始化 Swiper
                setTimeout(() => {
                    // var thumbSwiper = new Swiper('.thumbSwiper', {
                    //     spaceBetween: 10,
                    ...
                    //                     swiper.isEnd && swiper.touches.diff < 0) {
                    //                     e.preventDefault();
                    //                 }
                    //             }, { passive: false });
                    //         },
                    //         touchStart: function(swiper, e) {
                    //             // 记录初始位置
                    //             swiper.startPosition = swiper.getTranslate();
                    //         },
                    //         touchMove: function(swiper, e) {
                    //             // 获取当前位置
                    //             let currentPosition = swiper.getTranslate();
                                
                    //             // 在边界处阻止进一步滑动
                    //             if ((swiper.isBeginning && currentPosition > swiper.startPosition) ||
                    //                 (swiper.isEnd && currentPosition < swiper.startPosition)) {
                    //                 swiper.setTranslate(swiper.startPosition);
                    //                 return false;
                    //             }
                    //         },
                    ...
                    data.product.forEach((item, index) => {
                        if ($scope.stages[index]) {
                            ...
                            productImg.src = item.img_overlay;

                            productImg.onload = function() {
                                // 渲染主图
                                const mainCanvas = document.getElementById(`preview-canvas-${index}`);
                                const mainCtx = mainCanvas.getContext('2d');
                                mainCanvas.width = productImg.width;
                                mainCanvas.height = productImg.height;
                
                                // 渲染缩略图
                                const thumbCanvas = document.getElementById(`thumb-canvas-${index}`);
                                const thumbCtx = thumbCanvas.getContext('2d');
                                thumbCanvas.width = 100;  // 缩略图固定尺寸
                                thumbCanvas.height = 100;
                
                                // 获取设计内容
                                $scope.stages[index].canvas.renderAll();
                                const designDataUrl = $scope.stages[index].canvas.toDataURL({
                                    format: 'png',
                                    quality: 1
                                });
                                ...
                                previewImg.src = designDataUrl;

                                previewImg.onload = function() {
                                    const resultCanvas = $scope.create3DTextureEffect(productImg, previewImg);
                                    // const resultImageUrl = resultCanvas.toDataURL('image/png');
                                    // 绘制主图
                                    mainCtx.drawImage(resultCanvas, 0, 0, mainCanvas.width, mainCanvas.height);
                                    
                                    // 绘制缩略图
                                    thumbCtx.drawImage(resultCanvas, 0, 0, thumbCanvas.width, thumbCanvas.height);
                                };
                            };
                        }
                    });
                    // 将 Swiper 实例保存到全局变量（可选）
                    // window.mainSwiper = mainSwiper;
                    window.thumbSwiper = thumbSwiper;
                }, 100);

                // 添加关闭事件
                jQuery('.nbd-2d-preview-wrap').on('click', function(e) {
                    if (e.target === this) {
                        jQuery(this).remove();
                    }
                });
            ...
            //     method: 'POST',
            //     data: {
            //         action: 'nbd_get_product_info',  // 使用插件已有的action
            //         product_id: NBDESIGNCONFIG.product_id,
            //         variation_id: NBDESIGNCONFIG.variation_id,
            //         nonce: NBDESIGNCONFIG.nonce_get
            //     },
            //     success: function(response) {
            //         console.log('show2DPreview response', response);
            ...
            //                 // 绘制产品图片
            //                 previewCtx.drawImage(productImg, 0, 0, previewCanvas.width, previewCanvas.height);
                            
            //                 // 然后加载设计图
            //                 var designImg = new Image();
            //                 designImg.onload = function() {
            //                     // 在产品图上叠加设计图
            //                     previewCtx.drawImage(designImg, 0, 0, previewCanvas.width, previewCanvas.height);
            //                 };
            //                 designImg.src = dataUrl;
            //             };
            //             productImg.src = response.product_image;
            //         } else {
            //             // 如果没有产品图片，只显示设计图
            //             var img = new Image();
            //             img.onload = function() {
    ...
    $scope.take3DPreviewScreenshot = function() {
        console.log('take3DPreviewScreenshot ----');
        var iframe = document.getElementById('preview-3d-wrap');
        if (iframe && iframe.contentWindow) {
            // 调用iframe中的captureModelImages函数
            console.log('发送截图消息到iframe');
            var frame = document.getElementById('preview-3d-wrap');
            frame.contentWindow.postMessage(['capture_design', $scope.stages[0].design]);
        }
    };
    $scope.show3DPreview = function(){
        const previewButton = document.querySelector('.nbd-show-3d-preview');
        if(previewButton) {
            console.log('show3DPreview has previewButton', previewButton);
            if (previewButton.classList.contains('is_open')) {
                console.log('show3DPreview remove active');
                $scope.close3DPreview();
                return;
            } else {
                console.log('add active');
                const sidebar_content = document.querySelector('.tabs-content');
                const mainPanel = document.querySelector('.main');
                var width = jQuery(window).width();
                previewButton.classList.add('is_open');
                if(mainPanel && sidebar_content && width <= 1200) {
                    console.log('Setting stage-main-wrap position');
                    const offset = sidebar_content.offsetWidth / 2;
                    mainPanel.style.transform = `translateX(${offset}px)`;
                    mainPanel.style.transition = 'width 0.3s';
                }
            }
        }
    ...
    $scope.close3DPreview = function(){
        ...
        const previewButton = document.querySelector('.nbd-show-3d-preview');
        if(previewButton) {
            previewButton.classList.remove('is_open');
            previewButton.classList.remove('active');
        }
        const sidebar = document.querySelector('.nbd-sidebar');
        const mainPanel = document.querySelector('.main');
        var width = jQuery(window).width();
        var isOpen = sidebar.classList.contains('is_open');
        console.log('close3DPreview remove active isOpen: ' + isOpen);
        if(mainPanel && width <= 1200 && !isOpen) {
            console.log('Resetting stage-main-wrap position');
            mainPanel.style.transition = 'transform 0.3s ease';
            mainPanel.style.transform = '';
        }
    };
    $scope.update3DPreviewTexture = function(){
        ...
        frame.contentWindow.addEventListener('message', function(event) {
            if (event.data.type === 'capture_image') {
                console.log('capture_image message ---- ', event.data);
                // 将ArrayBuffer转换回Blob
                const blob = new Blob([event.data.data], {type: 'image/png'});
            ...
            } else if (event.data.type === 'capture_complete') {
                console.log('所有图像捕获完成');
            } else if (event.data.type === 'capture_error') {
                console.error('捕获错误:', event.data.error);
            }
        });
    };
...
nbdApp.filter("filterArt", function() {
    return function(arts, filterArt) {
        console.log('filterArt --- filterArt:', filterArt);
        var arrArt = [];
...
nbdApp.filter("filterBackground", function() {
    return function(bgs, filterBackground) {
        console.log('filterBackground --- bgs:', bgs);
        console.log('filterBackground --- filterBackground:', filterBackground);

        var arrBgs = [];
        bgs = _.sortBy(bgs, [function(o) { return o.key; }]);
        angular.forEach(bgs, function(bg, key) {
            // var check = [];
            // check['limit'] = arrBgs.length > ( filterBackground.perPage * filterBackground.currentPage  - 1 ) ? false : true;
            // if( !!filterBackground.search ){
            //     check['name'] = bg.key.toLowerCase().indexOf(filterBackground.search.toLowerCase()) >= 0 ? true : false;
            // }else{
            //     check['name'] = true;
            // };
            // if ( check['limit'] && check['name'])
                arrBgs.push(bg);
        });
        return arrBgs
    }
});
// nbdApp.filter("filterIcon", function() {
//     return function(reses, filter) {
//         console.log('filter res --- reses:', reses);
//         console.log('filter res --- filter:', filter);
...
// nbdApp.filter("filterShape", function() {
//     return function(icons, filterShape) {
//         console.log('filterShape --- icons:', icons);
//         console.log('filterShape --- filterShape:', filterShape);

//         var arrIcons = [];
//         icons = _.sortBy(icons, [function(o) { return o.key; }]);
...
nbdApp.factory('NBDDataFactory', function($http){
    return {
        get : function(action, data, callback, progressCallback) {
            // 打印函数入参
            // 初始化：data.type: typography(图片)
            // chinese click action: nbd_get_resource, data: {type: 'get_typo', folder: '1001'}
            // english click action: nbd_get_resource, data: {type: 'get_typo', folder: 'a25fd781529289019'}
            console.log('=== NBDDataFactory.get 函数入参 ===');
            console.log('NBDDataFactory action:', action);
            console.log('NBDDataFactory data:', data);
            console.log('=====================================');
            
            // 特殊处理 nbd_get_resource 请求，统一使用 getResource 方法
            if (action === 'nbd_get_resource') {
                console.log('检测到 nbd_get_resource 请求，调用getResource方法');
                return this.getResource(data, callback);
            }
            
            // 原有的 FormData 处理方式 英文click 触发$http.post
            // var formData = new FormData();
            ...
            //     }
            //     // 打印FormData内容
            //     console.log('NBDDataFactory key: ', key, ' value: ', value);
            //     // 打印当前FormData中的所有条目
            //     console.log('当前FormData内容:');
            ...
            //                 // console.log('uploadFile progress', progressBar);
            ...
            // console.log('NBDDataFactory url: ', url, ' callback: ', callback);
            // console.log('NBDDataFactory formData contents:');
            ...
            //     },
            //     function(response) {
            //         console.log('app-modern.min.js AJAX Error, url:', url);
            ...
            jQuery.ajax({
                ...
                beforeSend: function() {
                    ...
                    if (data.type === 'background') {
                        $('#nbd-photo-grid').html('<div class="loading">加载背景图片中...</div>');
                    }
                },
                success: function(response) {
                    ...
                    console.log('NBDDataFactory getResource --- 标准化后的响应:', standardizedResponse);
                    callback(standardizedResponse);
                },
                error: function(xhr, status, error) {
                    ...
                    // 显示错误信息
                    if (data.type === 'background') {
                        $('#nbd-photo-grid').html('<div class="error">加载失败：' + error + '</div>');
                    }
...
function receiveMessage(event){
    if (event.data && event.data.type === 'update_redirect_url') {
        NBDESIGNCONFIG['redirect_url'] = event.data.url;
        NBDESIGNCONFIG['variation_id'] = event.data.variation_id;
        NBDESIGNCONFIG['design'] = event.data.design;
        console.log('[app-modern] Received URL update in app-modern:', NBDESIGNCONFIG['redirect_url']);
        // 如果需要更新 Angular scope
        var scope = angular.element(document.getElementById("designer-controller")).scope();
    ...
    if( event.origin == window.location.origin ){
        var scope = angular.element(document.getElementById("designer-controller")).scope();
        if( event.data.type == 'update_variation_id' ){
            console.log('[app-modern] Received variation_id update in app-modern:', event.data.variation_id);
            NBDESIGNCONFIG['variation_id'] = event.data.variation_id;
        }
...
jQuery(document).ready(function(){
    ...
    //                         // 测试添加文本
    //                         if (result === fontName) {
    //                             scope.addText('测试文本 - ' + fontName, 'bodytext', {
    //                                 fontFamily: fontName,
    //                                 fontSize: 24,
    //                                 top: 100 + Math.random() * 200,
    //                                 left: 100 + Math.random() * 200
    ...
    //                         } else {
    //                             // 如果字体加载失败，使用Arial字体
    //                             scope.addText('测试文本 - ' + fontName + ' (使用Arial)', 'bodytext', {
    //                                 fontFamily: 'Arial',
    //                                 fontSize: 24,
    //                                 top: 100 + Math.random() * 200,
    //                                 left: 100 + Math.random() * 200
    ...
    //                 // 测试Arial字体
    //                 console.log('测试Arial字体');
    //                 scope.addText('测试文本 - Arial', 'bodytext', {
    //                     fontFamily: 'Arial',
    //                                     fontSize: 24,
    //                                     top: 100 + Math.random() * 200,
    //                                     left: 100 + Math.random() * 200
    ...
    //             // 自动测试字体
    //             setTimeout(function() {
    //                 if (scope.testNewFonts) {
    //                     console.log('自动测试新增字体');
    //                     scope.testNewFonts();
    //                 }
    //             }, 3000);
    //         }
