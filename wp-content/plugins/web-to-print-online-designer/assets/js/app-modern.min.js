    ...
    $scope.initSettings = function(){
        ...
        for (var res_type in $scope.resource) {
            ...
            if (value.hasOwnProperty('subPageTitle')) {
                ...
                var watch_filter = 'resource.'+ res_type + '.filter';
                // console.log('watchCollection init settings res_type ------', res_type, ' watch_filter: ', watch_filter);
                // $scope.$watch(
                //     () => value,
                //     (newVal, oldVal) => {
                //       if (newVal !== oldVal) {
                //         console.log(`[type: ${res_type}] change: ${oldVal} → ${newVal}`);
                //       }
                //     }
                // );
        ...
        watched_resources.forEach((wtype, index) => {
            var watch_filter = 'resource.'+ wtype + '.filter';
            ...
            $scope.$watchCollection(watch_filter, function(newVal, oldVal){
                ...
                console.log('watchCollection filter newVal ------', newVal.search, ' oldVal ------', oldVal.search);
