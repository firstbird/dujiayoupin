                                    ...
                                    if(NBDESIGNCONFIG['redirect_url'] != ""){
                                        ...
                                        if (nbd_window && nbd_window.NBDESIGNERPRODUCT) {
                                            ...
                                            if (NBDESIGNCONFIG['design'] != "") {
                                                console.log('NBDESIGNCONFIG design_id: ', NBDESIGNCONFIG['design_id']);
                                                    ...
                                                    try {
                                                        ...
                                                        if (window.parent && window.parent.postMessage) {
                                                            window.parent.postMessage({
                                                                ...
                                                                design: data,
                                                                designId: NBDESIGNCONFIG['design_id']
                                                            }, '*');
                                                        }
    ...
    $scope.saveCustomerFile = function(file, type, func) {
        ...
        NBDDataFactory.get('nbdesigner_customer_upload', {file: file}, function(data){
            ...
            if( data.flag == 1 ){
                ...
                // 上传失败的处理
                console.error('saveCustomerFile failed:', data.mes);
                $scope.toggleStageLoading();
                alert(data.mes || '上传失败，请重试');
                if (func) {
                    func();
                }
            }
...
nbdApp.factory('NBDDataFactory', function($http){
    return {
        get : function(action, data, callback, progressCallback) {
            ...
            console.log('NBDDataFactory url: ', url, ' action: ', action);
            $http.post(url, formData, config).then(
                function(response) {
                    console.log('NBDDataFactory success, action:', action, 'response:', response);
                    callback(response.data);
                },
                function(response) {
                    console.log('NBDDataFactory AJAX Error, url:', url, 'action:', action);
