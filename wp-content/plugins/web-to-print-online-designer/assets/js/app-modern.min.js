...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', 'filterBackgroundFilter', 'filterShapeFilter', '$timeout', '$http', '$document', '$interval',
    function($scope, FabricWindow, $window, NBDDataFactory, filterFontFilter, filterArtFilter, filterBackgroundFilter, filterShapeFilter, $timeout, $http, $document, $interval) {
    $scope.stages = [];
    var d = new Date(),
    t = d.getTime();
    ...
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            background: {filter: {perPage: 10, currentPage: 1, totalPage: 10}, data: [], onload: false, init: true, ilr: false, progressBar: 0, ossNextToken: '', hasMore: 'true', filteredBackgrounds: []},
...
/*                 if( angular.isDefined( data.area ) ){
    ...
    $scope.renderMasonryList = function(type, container, item, scrollContainer, init){  
        ...
        console.log('renderMasonryList container: ', container);
        imagesLoaded( jQuery(container), function() {
            if( !init ) jQuery(container).masonry('destroy');
            console.log('renderMasonryList has init, item: ', item);
            ...
            $grid.on('layoutComplete', function() {
                ...
                // 处理最后一行左对齐
                console.log('renderMasonryList layoutComplete');
    ...
    $scope.addImage = function(data, showLoading, hideLoading, additionalTitle, additionalValue, maskId ){
        ...
        fabric.Image.fromURL(url, function(op) {
            if( angular.isDefined( maskId ) || $scope.stages[$scope.currentStage].states.elementUpload ){
                ...
                console.log('addImage object.width: ', object.width, ' object.scaleX: ', object.scaleX, ' op.width: ', op.width);
                ...
                if( angular.isDefined( maskId ) ) {
                    ...
                    console.log('addImage maskId defined object.width: ', object.width, ' object.scaleX: ', object.scaleX, ' op.width: ', op.width);
                ...
                console.log('addImage2 op.width: ', op.width, ' op.height: ', op.height);
                ...
                console.log('addImage5 scaleX: ', new_width / op.width, ' scaleY: ', new_height / op.height);
