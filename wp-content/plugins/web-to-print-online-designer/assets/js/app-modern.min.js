...
nbdApp.controller('designCtrl', 
    ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document', '$interval',
    function($scope, FabricWindow, $window, NBDDataFactory, filterFontFilter, filterArtFilter,
...
/*                 if( angular.isDefined( data.area ) ){
    ...
    $scope.renderMasonryList = function(type, container, item, scrollContainer, init){  
        ...
        // if (type == 'icon' || type == 'shape' || type == 'paint') {
